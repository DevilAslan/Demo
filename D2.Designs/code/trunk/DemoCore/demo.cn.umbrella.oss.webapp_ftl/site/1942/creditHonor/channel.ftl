				...
				<div class="share_center">
				    ...
				    <a href="${basePath}cms/${siteId}/${channelLevel2}.htm">${channelName3!""} </a>
			   	  ...
			   	  <div class="list_box m30">
	                    ...
	                    <ul class="introduction_tabe introduction_tabe02">
                    			<li><a href="${basePath}cms/${siteId}/creditHonor.htm" class="intro_li">信用荣誉</a></li>
	                        <li class="no_border"><a href="${basePath}cms/${siteId}/creditBuild.htm">信用四项建设情况</a></li>
                    	</ul>
	                    <div class="honor_list holder-content blue-border" id="list">
	                        <@contentTag  where="siteId=${siteId},channelId=${channelLevel4}" page="1" pageSize="10"  sysId="credit">
														<#if contentList??&&contentList?size gt 0>
														<#list contentList as content >
															<a <#if (content_index+1)%3==0>
																		class="no_margin"
																 </#if>
															target="_blank" href="${basePath}cms/${content.siteId}/content/${content.contentId}.htm" title = "${content.title}">
