				    ...
				    <a href="${basePath}cms/${siteId}/${channelLevel2}.htm">${channelName3!""} </a>
			   	  ...
			   	  <div class="list_box m30">
	                    ...
	                    <ul class="introduction_tabe introduction_tabe02">
                    			<li><a href="${basePath}cms/${siteId}/creditHonor.htm">信用荣誉</a></li>
	                        <li class="no_border"><a href="${basePath}cms/${siteId}/creditBuild.htm" class="intro_li">信用四项建设情况</a></li>
                    	</ul>
	                    <ul class="ul_txt  holder-content blue-border" id="list">
	                        <@con.contents_orange_1 where="" channelPath=channelLevel4 page=page pageSize=pageSize basePath=basePath imgPath=basePath sysId=sysId query=query/>
	                    </ul>
