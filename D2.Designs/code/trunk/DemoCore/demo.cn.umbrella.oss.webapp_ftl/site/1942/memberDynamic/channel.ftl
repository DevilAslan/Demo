				    ...
				    <a href="${basePath}cms/${siteId}/${channelLevel2}.htm">${channelName3!""} </a>
			   	  ...
			   	  <div class="list_box m30">
			            ...
			            <div class="menu_right">
		            		<ul class="association_ul holder-content blue-border" id="list">
		                	<@con.contents_orange_1 where="" channelPath=channelLevel3 page=page pageSize=pageSize basePath=basePath imgPath=basePath sysId=sysId query=query/>
			                </ul>
