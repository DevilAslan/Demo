...
import cn.umbrella.wechat.bean.rep.MusicMessage;
import cn.umbrella.wechat.bean.rep.NewsMessage;
import cn.umbrella.wechat.bean.rep.TextMessage;
...
public class MessageUtil {
	...
	public static WXInputMessage parseXml(InputStream inputStream) throws Exception {
  		WXInputMessage msgReq = new WXInputMessage();
    ...
    //将response 消息 转换成 返回消息对象
  	@SuppressWarnings("unchecked")
	public static WXInputMessage xmlToObject(String respXml) throws UnsupportedEncodingException{
		WXInputMessage responseMessage = new WXInputMessage();
		SAXReader reader = new SAXReader();
    ...
    /**
     * 输入xml转换成WXInputMessage对象
     * @param xml
     * @return
     */
    public static WXInputMessage xmlToWXInputMessage(String xml) {  
    	xstream.alias("xml", WXInputMessage.class);
    	return (WXInputMessage) xstream.fromXML(xml);
    }
