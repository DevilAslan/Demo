...
if(jQuery) (function($){
	...
	function renderOption(id,name, option)
	{
	...
	function renderOptions(id,name, options, o)
	{
		var html = "";
		...
		for(var i = 0; i < options.length; i++) {
			if(options[i].optgroup) {
				...
				html += renderOptions(id,name, options[i].options, o);
				
				html += '</div>';
			}
			else {
				html += renderOption(id,name, options[i]);
			}
		}
	...
	function buildOptions(options)
	{
		...
		html += renderOptions(multiSelect.attr('id'),multiSelect.attr('selectname'), options, o);
	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			$(this).each( function() {
                ...
                multiSelect.attr("selectname", $(select).attr("name"));
