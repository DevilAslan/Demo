...
static Logger logger = Logger.getLogger(ImageUtil.class);
     ...
     * @param alpha 透明度：alpha 必须是范围 [0.0, 1.0] 之内（包含边界值）的一个浮点数字
     */
    public static BufferedImage pressText(String pressText, String srcImageFile, String fontName,
            int fontStyle, Color color, int fontSize,int x,
...
//    	try {
//    		
////    		URL resource = ImageUtil.class.getResource("images/new.gif");
////    		String file = resource.getFile();
//    		String property = System.getProperty("user.dir");
//    		System.out.println(property);
////    		File file =new File("D:/apache-tomcat-6.0.29/webapps/ztjklj/images/new.gif");
////    		System.out.println(file.isFile());
////    		Image src = ImageIO.read(file);
//    		String url = property + File.separator + "images" + File.separator + "new.gif";
//    		url = url.replace("\\", "/");
...
////    		Image src = ImageIO.read(file);
//    		
//			BufferedImage bufferedImage = ImageUtil.pressText("234567",file.getPath(),"宋体",Font.BOLD,Color.red,80, 0, 0, 0.5f);
//			String remoteDir = "zthd/images/saomabanyewu";
//			String newFileName = "new3.gif";
//			InputStream imageStreamFromBufferedImage = MatrixToImageWriter.getImageStreamFromBufferedImage(bufferedImage);
//			String filePath = FTPUtil.upload(newFileName,imageStreamFromBufferedImage, remoteDir);
...
//        ImageUtil.pressImage("e:/abc2.jpg", "e:/abc.jpg","e:/abc_pressImage.jpg", 0, 0, 0.5f);//测试OK
    	...
    	String url = "C:/Users/ThinkPad/Desktop/ruchangquan.png";
		
		BufferedImage bufferedImage = ImageUtil.pressText("000001", url, "微软雅黑", Font.BOLD, new Color(95,32,121), 30, -150, -360, 1.0f);
		String remoteDir = "zthd/images/saomabanyewu";
		String newFileName = "ruchangquan" + "000001" + ".png";
		InputStream imageStreamFromBufferedImage = MatrixToImageWriter.getImageStreamFromBufferedImage(bufferedImage);
		String filePath = FTPUtil.upload(newFileName,imageStreamFromBufferedImage, remoteDir);
		filePath = filePath.replace("\\", "/");
//		System.out.println(filePath);
