package cn.aslan.mj.common.utils.base;
...
public class DateStringUtility {
	 ...
	 * @param simpleDateFormatString 需要返回的格试 例yyyyMMddHHmmss
	 * @return String
	 */
	...
	public static String getNowMonth(String datestr) {
		...
		// 得到这个月的1号是星期几
		Date date = stringToDate(datestr, YYYY_MM_DD);
	...
	public static String getTwoDay(String str1, String str2) {
		...
		long day = 0;
		try {
			Date date = myFormatter.parse(str1);
	...
	public static String getWeek(String date, String num) {
		// 再转换为时间
		Date dd = stringToDate(date, YYYY_MM_DD);
		Calendar c = Calendar.getInstance();
		c.setTime(dd);
...
//			System.out.println(entry.getKey() + "：" + entry.getValue());
//		}
		Calendar cal1 = new Calendar();Calendar cal2;
		String formatStr = YYYY_MM_DD_HH_MM_SS;
		System.out.println(compare(cal1,cal2,formatStr));
	}
}
