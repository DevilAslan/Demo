...
function(a) {
            ...
            if (!this.grid) {
                ...
                L = function(a, b, c, e) {
                    ...
                    d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) { - 1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b: 1 : (H.call(d, !1, !0), b = 1);
                        ...
                        if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                            e && (T *= e + 1);
                            var W, X = $.isFunction(d.p.afterInsertRow),
                            Y = !1,
                ...
                N = function() {
                    function a(b) {
                        ...
                        if (null != b.rules) try {
                            for (f = b.rules.length && "OR" === b.groupOp.toString().toUpperCase(), f && r.orBegin(), c = 0; c < b.rules.length; c++) h = b.rules[c],
                            g = b.groupOp.toString().toUpperCase(),
                            q[h.op] && h.field && (k > 0 && g && "OR" === g && (r = r.or()), i = j[h.field], "date" === i.stype && i.srcfmt && i.newfmt && i.srcfmt !== i.newfmt && (h.data = $.jgrid.parseDate.call(d, i.newfmt, h.data, i.srcfmt)), r = q[h.op](r, g)(h.field, h.data, j[h.field])),
                            k++;
                            f && r.orEnd()
                        } catch(m) {
                            alert(m)
                    ...
                    if ($.isArray(d.p.data)) {
                        ...
                        if (d.p.ignoreCase && (r = r.ignoreCase()), d.p.search === !0) {
                            ...
                            if (u)"string" == typeof u && (u = $.jgrid.parse(u)),
                            a(u);
                            else try {
                                ...
                                r = q[d.p.postData.searchOper](r)(d.p.postData.searchField, d.p.postData.searchString, j[d.p.postData.searchField])
                            } catch(v) {}
                        ...
                        var w = r.select(),
                        x = parseInt(d.p.rowNum, 10),
                        y = w.length,
                        z = parseInt(d.p.page, 10),
                        A = Math.ceil(y / x),
                        B = {};
                        ...
                        return w = d.p.treeGrid && d.p.search ? $(d).jqGrid("searchTree", w) : w.slice((z - 1) * x, z * x),
                        r = null,
                        j = null,
                        B[d.p.localReader.total] = A,
                        B[d.p.localReader.page] = z,
                        B[d.p.localReader.records] = y,
                        B[d.p.localReader.root] = w,
                        B[d.p.localReader.userdata] = d.p.userData,
                        w = null,
                        B
                    }
                },
    ...
    $.jgrid.extend({
        ...
        addRowData: function(a, b, c, d) { - 1 === $.inArray(c, ["first", "last", "before", "after"]) && (c = "last");
...
function(a) {
    ...
    a.fn.fmatter = function(b, c, d, e, f) {
        var g = c;
        d = a.extend({},
        a.jgrid.getRegional(this, "formatter"), d);
        try {
    ...
    a.fn.fmatter.showlink = function(b, c) {
        ...
        f = "";
        return void 0 !== c.colModel && void 0 !== c.colModel.formatoptions && (e = a.extend({},
        e, c.colModel.formatoptions)),
        e.target && (f = "target=" + e.target),
        d = e.baseLinkUrl + e.showAction + "?" + e.idName + "=" + c.rowId + e.addParam,
        a.fmatter.isString(b) || a.fmatter.isNumber(b) ? "<a " + f + ' href="' + d + '">' + b + "</a>": a.fn.fmatter.defaultFormat(b, c)
    },
    ...
    a.fn.fmatter.date = function(b, c, d, e) {
        ...
        f.reformatAfterEdit || "edit" !== e ? a.fmatter.isEmpty(b) ? a.fn.fmatter.defaultFormat(b, c) : a.jgrid.parseDate.call(this, f.srcformat, b, f.newformat, f) : a.fn.fmatter.defaultFormat(b, c)
    },
    ...
    a.fn.fmatter.actions = function(b, c) {
        ...
        return e.editformbutton ? (d = "id='jEditButton_" + f + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'formedit'); " + k, g += "<div title='" + h.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + d + "><span class='" + j.icon_base + " " + i.icon_edit + "'></span></div>") : e.editbutton && (d = "id='jEditButton_" + f + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'edit'); " + k, g += "<div title='" + h.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + d + "><span class='" + j.icon_base + " " + i.icon_edit + "'></span></div>"),
        e.delbutton && (d = "id='jDeleteButton_" + f + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'del'); " + k, g += "<div title='" + h.deltitle + "' style='float:left;' class='ui-pg-div ui-inline-del' " + d + "><span class='" + j.icon_base + " " + i.icon_del + "'></span></div>"),
        d = "id='jSaveButton_" + f + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'save'); " + k,
        g += "<div title='" + h.savetitle + "' style='float:left;display:none' class='ui-pg-div ui-inline-save' " + d + "><span class='" + j.icon_base + " " + i.icon_save + "'></span></div>",
        d = "id='jCancelButton_" + f + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'cancel'); " + k,
        g += "<div title='" + h.canceltitle + "' style='float:left;display:none;' class='ui-pg-div ui-inline-cancel' " + d + "><span class='" + j.icon_base + " " + i.icon_cancel + "'></span></div>",
        "<div style='margin-left:8px;'>" + g + "</div>"
    },
    ...
    a.unformat.date = function(b, c) {
        ...
        d, c.formatoptions)),
        a.fmatter.isEmpty(b) ? a.fn.fmatter.defaultFormat(b, c) : a.jgrid.parseDate.call(this, d.newformat, b, d.srcformat, d)
    }
}); !
function(a) {
    "use strict";
    ...
    a.extend(a.jgrid, {
        ...
        hideModal: function(b, c) {
            ...
            if (c.formprop && d && c.form) {
                ...
                g.indexOf("px") > -1 && (g = parseFloat(g));
                var h, i;
                "edit" === c.form ? (h = "#" + a.jgrid.jqID("FrmGrid_" + c.gb.substr(6)), i = "formProp") : "view" === c.form && (h = "#" + a.jgrid.jqID("ViewGrid_" + c.gb.substr(6)), i = "viewProp"),
                a(d).data(i, {
        ...
        createModal: function(b, c, d, e, f, g, h) {
            ...
            h = a.extend({},
            h || {}),
            m.className = "ui-jqdialog " + k.modal,
            m.id = b.themodal;
            var n = document.createElement("div");
            n.className = "ui-jqdialog-titlebar " + k.header,
            n.id = b.modalhead,
            a(n).append("<span class='ui-jqdialog-title'>" + d.caption + "</span>");
            ...
            a(n).append(o),
            j ? (m.dir = "rtl", a(".ui-jqdialog-title", n).css("float", "right"), a(".ui-jqdialog-titlebar-close", n).css("left", "0.3em")) : (m.dir = "ltr", a(".ui-jqdialog-title", n).css("float", "left"), a(".ui-jqdialog-titlebar-close", n).css("right", "0.3em"));
            var p = document.createElement("div");
            a(p).addClass("ui-jqdialog-content " + k.content).attr("id", b.modalcontent),
            a(p).append(c),
            m.appendChild(p),
            a(m).prepend(n),
            g === !0 ? a("body").append(m) : "string" == typeof g ? a(g).append(m) : a(m).insertBefore(e),
            a(m).css(h),
            ...
            q)).attr({
                ...
                "aria-hidden": "true"
            }), void 0 === d.drag && (d.drag = !0), void 0 === d.resize && (d.resize = !0), d.drag) if (a(n).css("cursor", "move"), a.fn.tinyDraggable) a(m).tinyDraggable({
            ...
            if (d.resize) if (a.fn.jqResize) a(m).append("<div class='jqResize " + k.resizable + " " + l.icon_base + " " + k.icon_resizable + "'></div>"),
        ...
        viewModal: function(b, c) {
            ...
            c || {}), void 0 === c.focusField && (c.focusField = 0), c.focusField = "number" == typeof c.focusField && c.focusField >= 0 ? parseInt(c.focusField, 10) : "boolean" != typeof c.focusField || c.focusField ? 0 : !1, a.fn.jqm && c.jqm === !0) c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow();
        ...
        info_dialog: function(b, c, d, e) {
            ...
            a.fn.jqm && !g && (g = !1);
            var k, l = "";
            if (f.buttons.length > 0) for (k = 0; k < f.buttons.length; k++) void 0 === f.buttons[k].id && (f.buttons[k].id = "info_button_" + k),
            l += "<a id='" + f.buttons[k].id + "' class='fm-button " + j.button + "'>" + f.buttons[k].text + "</a>";
            var m = isNaN(f.dataheight) ? f.dataheight: f.dataheight + "px",
            n = "text-align:" + f.align + ";",
            o = "<div id='info_id'>";
            o += "<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:" + m + ";" + n + "'>" + c + "</div>",
            o += d ? "<div class='" + i.header + "' style='text-align:" + f.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'><a id='closedialog' class='fm-button " + j.button + "'>" + d + "</a>" + l + "</div>": "" !== l ? "<div class='" + i.header + "' style='text-align:" + f.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'>" + l + "</div>": "",
            o += "</div>";
            try {
        ...
        bindEv: function(b, c) {
            var d = this;
            a.isFunction(c.dataInit) && c.dataInit.call(d, b, c),
                ...
                if (c.multiple === !0 ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
                    ...
                    a.ajax(a.extend({
                        ...
                        success: function(b) {
                            ...
                            "string" == typeof m && (m = a(a.trim(m)).html()),
                            m && (a(e).append(m), g(e, h, o ? ["postData"] : void 0), void 0 === h.size && (h.size = j ? 3 : 1), j ? (d = f.split(","), d = a.map(d,
                            function(b) {
                                return a.trim(b)
                                ...
                                if (a("option", e).each(function(b) {
                                    ...
                                    (a.inArray(a.trim(c), d) > -1 || a.inArray(a.trim(f), d) > -1) && (this.selected = "selected")
                                    ...
                                    a.each(g,
                                    function() {
                                        return b = this.index || this.name,
                                        h.name === b ? (this.searchoptions.dataUrl = null, this.searchoptions.value = l, !1) : void 0
                                    })
                                }
                    ...
                    var r, s, t, u, v, w, x = void 0 === c.separator ? ":": c.separator,
                    y = void 0 === c.delimiter ? ";": c.delimiter;
                    if ("string" == typeof c.value) for (r = c.value.split(y), q = 0; q < r.length; q++) s = r[q].split(x),
                    s.length > 2 && (s[1] = a.map(s,
                    function(a, b) {
                        return b > 0 ? a: void 0
                    }).join(x)),
                    ...
                    t.innerHTML = s[1],
                    h.appendChild(t),
                    l || a.trim(s[0]) !== a.trim(d) && a.trim(s[1]) !== a.trim(d) || (t.selected = "selected"),
                    l && (a.inArray(a.trim(s[1]), m) > -1 || a.inArray(a.trim(s[0]), m) > -1) && (t.selected = "selected");
                    else if ("[object Array]" === Object.prototype.toString.call(c.value)) for (u = c.value, q = 0; q < u.length; q++) 2 === u[q].length && (v = u[q][0], w = u[q][1], t = document.createElement("option"), t.setAttribute("role", "option"), t.value = v, t.innerHTML = w, h.appendChild(t), l || a.trim(v) !== a.trim(d) && a.trim(w) !== a.trim(d) || (t.selected = "selected"), l && (a.inArray(a.trim(w), m) > -1 || a.inArray(a.trim(v), m) > -1) && (t.selected = "selected"));
        ...
        checkValues: function(b, c, d, e) {
            ...
            if (void 0 === d) if ("string" == typeof c) {
                for (g = 0, j = m.length; j > g; g++) if (m[g].name === c) {
                    f = m[g].editrules,
                    c = g,
                    null != m[g].formoptions && (h = m[g].formoptions.label);
                    break
                }
...
function(a) {
    ...
    a.jgrid.extend({
        editGridRow: function(c, d) {
            ...
            this.each(function() {
                    ...
                    return a(z).find(".FormElement").each(function() {
                        ...
                        if (c.length) {
                            ...
                            case "select-multiple":
                                ...
                                t[this.name] = t[this.name] ? t[this.name].join(",") : "";
                                var g = [];
                    ...
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(n) {
                        if (h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'": "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
                            ...
                            a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), (b[r.p.id].checkOnSubmit || b[r.p.id].checkOnUpdate) && (b[r.p.id]._savedData[h] = k), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(m).addClass(g.inputClass), E) a(K).find("#" + h).replaceWith(m);
                                ...
                                0 === j.length && (j = a("<tr " + l + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + h), a(j).append(t), a(e).append(j), j[0].rp = w),
                                a("td:eq(" + (y - 2) + ")", j[0]).html("<label for='" + h + "'>" + (void 0 === v.label ? d.p.colNames[n] : v.label) + "</label>"),
                                a("td:eq(" + (y - 1) + ")", j[0]).append(v.elmprefix).append(m).append(v.elmsuffix)
                            }
                            "custom" === this.edittype && a.isFunction(u.custom_value) && u.custom_value.call(r, a("#" + h, x), "set", k),
                            a.jgrid.bindEv.call(r, m, u),
                            p[o] = n,
                            o++
                        }
                    }), o > 0) {
                ...
                function i(c, d, e) {
                    ...
                    n && (a('td[role="gridcell"]', n).each(function(h) {
                        if (f = m[h].name, "cb" !== f && "subgrid" !== f && "rn" !== f && m[h].editable === !0) {
                            ...
                            case "image":
                            case "textarea":
                                ("&nbsp;" === g || "&#160;" === g || 1 === g.length && 160 === g.charCodeAt(0)) && (g = ""),
                                a("#" + f, e).val(g);
                                break;
                            case "select":
                                var j = g.split(",");
                            ...
                            case "checkbox":
                                ...
                                g.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== g ? (a("#" + f, e)[r.p.useProp ? "prop": "attr"]("checked", !0), a("#" + f, e)[r.p.useProp ? "prop": "attr"]("defaultChecked", !0)) : (a("#" + f, e)[r.p.useProp ? "prop": "attr"]("checked", !1), a("#" + f, e)[r.p.useProp ? "prop": "attr"]("defaultChecked", !1)); (b[r.p.id].checkOnSubmit === !0 || b[r.p.id].checkOnUpdate) && (g = a("#" + f, e).is(":checked") ? a("#" + f, e).val() : a("#" + f, e).attr("offval"));
                                break;
                            case "custom":
                                try {
                ...
                function k() {
                    ...
                    q && "object" == typeof q && (t = q),
                    a.isFunction(b[r.p.id].beforeCheckValues) && (q = b[r.p.id].beforeCheckValues.call(r, t, a(x), v), q && "object" == typeof q && (t = q));
                    ...
                    if (j(), n[0] && (o = a(r).triggerHandler("jqGridAddEditClickSubmit", [b[r.p.id], t, v]), void 0 === o && a.isFunction(b[r.p.id].onclickSubmit) && (o = b[r.p.id].onclickSubmit.call(r, b[r.p.id], t, v) || {}), n = a(r).triggerHandler("jqGridAddEditBeforeSubmit", [t, a(x), v]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[r.p.id].beforeSubmit) && (n = b[r.p.id].beforeSubmit.call(r, t, a(x), v))), n[0] && !b[r.p.id].processing) {
                        ...
                        var y = a.extend({
                            ...
                            complete: function(g, j) {
                                var l;
                                if (a("#sData", z + "_2").removeClass(h.active), t[e] = r.p.idPrefix + t[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(r).triggerHandler("jqGridAddEditErrorTextFormat", [g, v]), n[1] = a.isFunction(b[r.p.id].errorTextFormat) ? b[r.p.id].errorTextFormat.call(r, g, v) : j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(r).triggerHandler("jqGridAddEditAfterSubmit", [g, t, v]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[r.p.id].afterSubmit) && (n = b[r.p.id].afterSubmit.call(r, g, t, v))), n[0] === !1) a(".FormError", x).html(n[1]),
                                a(".FormError", x).show();
                                else if (r.p.autoencode && a.each(t,
                                function(b, c) {
                                ...
                                1e3)) : r.p.treeGrid === !0 ? a(r).jqGrid("setTreeRow", t[e], t) : a(r).jqGrid("setRowData", t[e], t), b[r.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(A.themodal), {
                                    ...
                                    a(r).triggerHandler("jqGridAddEditAfterComplete", [c, t, a(x), v]),
                                    b[r.p.id].afterComplete.call(r, c, t, a(x), v),
                                    c = null
                                },
                        ...
                        if (y.url || b[r.p.id].useDataProxy || (a.isFunction(r.p.dataProxy) ? b[r.p.id].useDataProxy = !0 : (n[0] = !1, n[1] += " " + F.nourl)), n[0]) if (b[r.p.id].useDataProxy) {
                            ...
                            void 0 === B && (B = [!0, ""]),
                            B[0] === !1 ? (n[0] = !1, n[1] = B[1] || "Error deleting the selected row!") : (y.data.oper === p.addoper && b[r.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(A.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(w),
                                jqm: d.jqModal,
                                onClose: b[r.p.id].onClose,
                                removemodal: b[r.p.id].removemodal,
                ...
                function m() {
                    var c = !0;
                    return a(".FormError", x).hide(),
                    b[r.p.id].checkOnUpdate && (t = {},
                    e(), u = l(t, b[r.p.id]._savedData), u && (a(x).data("disabled", !0), a(".confirm", "#" + A.themodal).show(), c = !1)),
                    c
                }
                function n() {
                    var b;
                ...
                function o(b, c) {
                    var d = c[1].length - 1;
                    0 === b ? a("#pData", s).addClass(h.disabled) : void 0 !== c[1][b - 1] && a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass(h.disabled) ? a("#pData", s).addClass(h.disabled) : a("#pData", s).removeClass(h.disabled),
                    b === d ? a("#nData", s).addClass(h.disabled) : void 0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass(h.disabled) ? a("#nData", s).addClass(h.disabled) : a("#nData", s).removeClass(h.disabled)
                }
                function p() {
                ...
                if (r.grid && c) {
                    ...
                    b[r.p.id].styleUI = r.p.styleUI || "jQueryUI",
                    a.jgrid.isMobile() && (b[r.p.id].resize = !1),
                    "new" === c ? (c = "_empty", v = "add", d.caption = b[r.p.id].addCaption) : (d.caption = b[r.p.id].editCaption, v = "edit"),
                    d.recreateForm || a(r).data("formProp") && a.extend(b[a(this)[0].p.id], a(r).data("formProp"));
                    var G = !0;
                    ...
                    if (E ? (H = q(b[a(this)[0].p.id].template), s = z) : (H = a("<table id='" + y + "' class='EditTable ui-common-table'><tbody></tbody></table>"), s = z + "_2"), x = "#" + a.jgrid.jqID(x), a(K).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(K).append("<div class='tinfo topinfo'>" + b[r.p.id].topinfo + "</div>"), a(r.p.colModel).each(function() {
                        ...
                        M = L ? "nData": "pData",
                        N = L ? "pData": "nData",
                        O = "<a id='" + M + "' class='fm-button " + h.button + "'><span class='" + h.icon_base + " " + g.icon_prev + "'></span></a>",
                        P = "<a id='" + N + "' class='fm-button " + h.button + "'><span class='" + h.icon_base + " " + g.icon_next + "'></span></a>",
                        Q = "<a id='sData' class='fm-button " + h.button + "'>" + d.bSubmit + "</a>",
                        R = "<a id='cData' class='fm-button " + h.button + "'>" + d.bCancel + "</a>",
                        S = "<table style='height:auto' class='EditTable ui-common-table' id='" + y + "_2'><tbody><tr><td colspan='2'><hr class='" + h.content + "' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (L ? P + O: O + P) + "</td><td class='EditButton'>" + Q + R + "</td></tr>";
                        ...
                        if (E ? (a(K).find("#pData").replaceWith(O), a(K).find("#nData").replaceWith(P), a(K).find("#sData").replaceWith(Q), a(K).find("#cData").replaceWith(R), V = a("<div id=" + y + "></div>").append(K)) : V = a("<div></div>").append(K).append(S), a(K).append("<div class='binfo topinfo bottominfo'>" + b[r.p.id].bottominfo + "</div>"), a.jgrid.createModal(A, V, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(r.p.id), a("#gbox_" + a.jgrid.jqID(r.p.id))[0]), L && (a("#pData, #nData", z + "_2").css("float", "right"), a(".EditButton", z + "_2").css("text-align", "left")), b[r.p.id].topinfo && a(".tinfo", x).show(), b[r.p.id].bottominfo && a(".binfo", x).show(), V = null, S = null, a("#" + a.jgrid.jqID(A.themodal)).keydown(function(c) {
                            ...
                            if (b[r.p.id].savekey[0] === !0 && c.which === b[r.p.id].savekey[1] && "TEXTAREA" !== e.tagName) return a("#sData", z + "_2").trigger("click"),
                            !1;
                            ...
                            if (b[r.p.id].navkeys[0] === !0) {
                                ...
                                if (c.which === b[r.p.id].navkeys[1]) return a("#pData", s).trigger("click"),
                                !1;
                                if (c.which === b[r.p.id].navkeys[2]) return a("#nData", s).trigger("click"),
                                !1
                            }
                            ...
                            Q = "<a id='sNew' class='fm-button " + h.button + "' style='z-index:1002'>" + d.bYes + "</a>",
                            P = "<a id='nNew' class='fm-button " + h.button + "' style='z-index:1002;margin-left:5px'>" + d.bNo + "</a>",
                            R = "<a id='cNew' class='fm-button " + h.button + "' style='z-index:1002;margin-left:5px;'>" + d.bExit + "</a>";
                            var W = d.zIndex || 999;
                            W++,
                            a("<div class='" + d.overlayClass + " jqgrid-overlay confirm' style='z-index:" + W + ";display:none;'>&#160;</div><div class='confirm ui-jqconfirm " + h.content + "' style='z-index:" + (W + 1) + "'>" + d.saveData + "<br/><br/>" + Q + P + R + "</div>").insertAfter(x),
                            a("#sNew", "#" + a.jgrid.jqID(A.themodal)).click(function() {
                                return k(),
                                a(x).data("disabled", !1),
                                a(".confirm", "#" + a.jgrid.jqID(A.themodal)).hide(),
                                !1
                            }),
                            a("#nNew", "#" + a.jgrid.jqID(A.themodal)).click(function() {
                                return a(".confirm", "#" + a.jgrid.jqID(A.themodal)).hide(),
                                a(x).data("disabled", !1),
                                setTimeout(function() {
                                    a(":input:visible", x)[0].focus()
                                },
                            ...
                            a("#cNew", "#" + a.jgrid.jqID(A.themodal)).click(function() {
                                return a(".confirm", "#" + a.jgrid.jqID(A.themodal)).hide(),
                                a(x).data("disabled", !1),
                                a.jgrid.hideModal("#" + a.jgrid.jqID(A.themodal), {
                                    gb: "#gbox_" + a.jgrid.jqID(w),
                                    jqm: d.jqModal,
                                    onClose: b[r.p.id].onClose,
                                    removemodal: b[r.p.id].removemodal,
                        ...
                        a(r).triggerHandler("jqGridAddEditInitializeForm", [a(x), v]),
                        a.isFunction(b[r.p.id].onInitializeForm) && b[r.p.id].onInitializeForm.call(r, a(x), v),
                        "_empty" !== c && b[r.p.id].viewPagerButtons ? a("#pData,#nData", s).show() : a("#pData,#nData", s).hide(),
                        a(r).triggerHandler("jqGridAddEditBeforeShowForm", [a(x), v]),
                        a.isFunction(b[r.p.id].beforeShowForm) && b[r.p.id].beforeShowForm.call(r, a(x), v),
                        a("#" + a.jgrid.jqID(A.themodal)).data("onClose", b[r.p.id].onClose),
                        a.jgrid.viewModal("#" + a.jgrid.jqID(A.themodal), {
                            ...
                            onHide: function(b) {
                                var c = a("#editmod" + w)[0].style.height,
                                d = a("#editmod" + w)[0].style.width;
                                c.indexOf("px") > -1 && (c = parseFloat(c)),
                                d.indexOf("px") > -1 && (d = parseFloat(d)),
                                a(r).data("formProp", {
                        ...
                        a("#sData", s).click(function() {
                            ...
                            a(".FormError", x).hide(),
                            e(),
                            "_empty" === t[r.p.id + "_id"] ? k() : d.checkOnSubmit === !0 ? (u = l(t, b[r.p.id]._savedData), u ? (a(x).data("disabled", !0), a(".confirm", "#" + a.jgrid.jqID(A.themodal)).show()) : k()) : k(),
                            !1
                        }),
                        ...
                        a("#nData", s).click(function() {
                            ...
                            if (b[0] = parseInt(b[0], 10), -1 !== b[0] && b[1][b[0] + 1]) {
                                ...
                                i(b[1][b[0] + 1], r, x),
                                a(r).jqGrid("setSelection", b[1][b[0] + 1]),
                                a(r).triggerHandler("jqGridAddEditAfterClickPgButtons", ["next", a(x), b[1][b[0]]]),
                                a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(r, "next", a(x), b[1][b[0] + 1]),
                                o(b[0] + 1, b)
                            }
                            return ! 1
                        }),
                        a("#pData", s).click(function() {
                            ...
                            if ( - 1 !== b[0] && b[1][b[0] - 1]) {
                                ...
                                i(b[1][b[0] - 1], r, x),
                                a(r).jqGrid("setSelection", b[1][b[0] - 1]),
                                a(r).triggerHandler("jqGridAddEditAfterClickPgButtons", ["prev", a(x), b[1][b[0]]]),
                                a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(r, "prev", a(x), b[1][b[0] - 1]),
                                o(b[0] - 1, b)
                            }
                            return ! 1
                        }),
                        a(r).triggerHandler("jqGridAddEditAfterShowForm", [a(x), v]),
                        a.isFunction(b[r.p.id].afterShowForm) && b[r.p.id].afterShowForm.call(r, a(x), v);
                        var X = p();
                        o(X[0], X)
                    }
                }
        ...
        viewGridRow: function(c, d) {
            ...
            b[a(this)[0].p.id] = d,
            this.each(function() {
                function e() { (b[l.p.id].closeOnEscape === !0 || b[l.p.id].navkeys[0] === !0) && setTimeout(function() {
                ...
                function f(b, c, e, f) {
                    ...
                    if (a(c.p.colModel).each(function() {
                        i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1,
                        i || "right" !== this.align || (this.formatter && -1 !== a.inArray(this.formatter, w) ? x = Math.max(x, parseInt(this.width, 10)) : y = Math.max(y, parseInt(this.width, 10)))
                        ...
                        if (g = this.name, o = !1, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'": "", p = "boolean" != typeof this.viewable ? !0 : this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && p) {
                            k = s === !1 ? "": g === c.p.ExpandColumn && c.p.treeGrid === !0 ? a("td:eq(" + b + ")", c.rows[s]).text() : a("td:eq(" + b + ")", c.rows[s]).html(),
                            o = "right" === this.align && 0 !== n ? !0 : !1;
                            var d = a.extend({},
                            {
                                rowabove: !1,
                                rowcontent: ""
                            ...
                            0 === j.length && (j = a("<tr " + l + " rowpos='" + h + "'></tr>").addClass("FormData").attr("id", "trv_" + g), a(j).append(u), a(e).append(j), j[0].rp = h),
                            a("td:eq(" + (m - 2) + ")", j[0]).html("<b>" + (void 0 === d.label ? c.p.colNames[b] : d.label) + "</b>"),
                            a("td:eq(" + (m - 1) + ")", j[0]).append("<span>" + k + "</span>").attr("id", "v_" + g),
                            o && a("td:eq(" + (m - 1) + ") span", j[0]).css({
                                "text-align": "right",
                                width: n + "px"
                            }),
                            r[q] = b,
                ...
                function i(b, c) {
                    var d, e, f, g, h = 0;
                    g = a(c).jqGrid("getInd", b, !0),
                    g && (a("td", g).each(function(b) {
                        d = c.p.colModel[b].name,
                        e = c.p.colModel[b].editrules && c.p.colModel[b].editrules.edithidden === !0 ? !1 : c.p.colModel[b].hidden === !0 ? !0 : !1,
                        "cb" !== d && "subgrid" !== d && "rn" !== d && (f = d === c.p.ExpandColumn && c.p.treeGrid === !0 ? a(this).text() : a(this).html(), d = a.jgrid.jqID("v_" + d), a("#" + d + " span", "#" + o).html(f), e && a("#" + d, "#" + o).parents("tr:first").hide(), h++)
                    }), h > 0 && a("#id_g", "#" + o).val(b))
                }
                function j(b, c) {
                    var d = c[1].length - 1;
                    0 === b ? a("#pData", "#" + o + "_2").addClass(h.disabled) : void 0 !== c[1][b - 1] && a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass(h.disabled) ? a("#pData", o + "_2").addClass(h.disabled) : a("#pData", "#" + o + "_2").removeClass(h.disabled),
                    b === d ? a("#nData", "#" + o + "_2").addClass(h.disabled) : void 0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass(h.disabled) ? a("#nData", o + "_2").addClass(h.disabled) : a("#nData", "#" + o + "_2").removeClass(h.disabled)
                }
                function k() {
                ...
                if (l.grid && c) {
                    ...
                    u = 1,
                    v = 0;
                    b[l.p.id].styleUI = l.p.styleUI || "jQueryUI",
                    d.recreateForm || a(l).data("viewProp") && a.extend(b[a(this)[0].p.id], a(l).data("viewProp"));
                    ...
                    if (a(l.p.colModel).each(function() {
                        var a = this.formoptions;
                        u = Math.max(u, a ? a.colpos || 0 : 0),
                        v = Math.max(v, a ? a.rowpos || 0 : 0)
                        ...
                        a.jgrid.createModal(r, H, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(l.p.id), a("#gview_" + a.jgrid.jqID(l.p.id))[0]),
                        A && (a("#pData, #nData", "#" + o + "_2").css("float", "right"), a(".EditButton", "#" + o + "_2").css("text-align", "left")),
                        d.viewPagerButtons || a("#pData, #nData", "#" + o + "_2").hide(),
                        H = null,
                        a("#" + r.themodal).keydown(function(c) {
                            ...
                            !1;
                            if (d.navkeys[0] === !0) {
                                if (c.which === d.navkeys[1]) return a("#pData", "#" + o + "_2").trigger("click"),
                                !1;
                                if (c.which === d.navkeys[2]) return a("#nData", "#" + o + "_2").trigger("click"),
                                !1
                            }
                        }),
                        d.closeicon = a.extend([!0, "left", g.icon_close], d.closeicon),
                        d.closeicon[0] === !0 && a("#cData", "#" + o + "_2").addClass("right" === d.closeicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='" + h.icon_base + " " + d.closeicon[2] + "'></span>"),
                        a.isFunction(d.beforeShowForm) && d.beforeShowForm.call(l, a("#" + n)),
                        ...
                        a("#nData", "#" + o + "_2").click(function() {
                            a("#FormError", "#" + o).hide();
                            var b = k();
                            return b[0] = parseInt(b[0], 10),
                            -1 !== b[0] && b[1][b[0] + 1] && (a.isFunction(d.onclickPgButtons) && d.onclickPgButtons.call(l, "next", a("#" + n), b[1][b[0]]), i(b[1][b[0] + 1], l), a(l).jqGrid("setSelection", b[1][b[0] + 1]), a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(l, "next", a("#" + n), b[1][b[0] + 1]), j(b[0] + 1, b)),
                            e(),
                            !1
                        }),
                        a("#pData", "#" + o + "_2").click(function() {
                            a("#FormError", "#" + o).hide();
                            var b = k();
                            return - 1 !== b[0] && b[1][b[0] - 1] && (a.isFunction(d.onclickPgButtons) && d.onclickPgButtons.call(l, "prev", a("#" + n), b[1][b[0]]), i(b[1][b[0] - 1], l), a(l).jqGrid("setSelection", b[1][b[0] - 1]), a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(l, "prev", a("#" + n), b[1][b[0] - 1]), j(b[0] - 1, b)),
                            e(),
                            !1
                        });
                        var I = k();
        ...
        delGridRow: function(c, d) {
            ...
            this.each(function() {
                var e = this;
                if (e.grid && c) {
                    var f, i, j, k, l = a.isFunction(b[e.p.id].beforeShowForm),
                    ...
                    if (b[e.p.id].styleUI = e.p.styleUI || "jQueryUI", a.isArray(c) && (c = c.join()), void 0 !== a("#" + a.jgrid.jqID(t.themodal))[0]) {
                        ...
                        a("#DelData>td", "#" + r).text(c),
                        a("#DelError", "#" + r).hide(),
                        b[e.p.id].processing === !0 && (b[e.p.id].processing = !1, a("#dData", "#" + r).removeClass(h.active)),
                        l && b[e.p.id].beforeShowForm.call(e, a("#" + r)),
                        ...
                        var u = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight: b[e.p.id].dataheight + "px",
                        ...
                        w += "<tr id='DelError' style='display:none'><td class='" + h.error + "'></td></tr>",
                        w += "<tr id='DelData' style='display:none'><td >" + c + "</td></tr>",
                        w += '<tr><td class="delmsg" style="white-space:pre;">' + b[e.p.id].msg + "</td></tr><tr><td >&#160;</td></tr>",
                        w += "</tbody></table></div>";
                        var x = "<a id='dData' class='fm-button " + h.button + "'>" + d.bSubmit + "</a>",
                        ...
                        d.delicon = a.extend([!0, "left", g.icon_del], b[e.p.id].delicon),
                        d.cancelicon = a.extend([!0, "left", g.icon_cancel], b[e.p.id].cancelicon),
                        d.delicon[0] === !0 && a("#dData", "#" + r + "_2").addClass("right" === d.delicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='" + h.icon_base + " " + d.delicon[2] + "'></span>"),
                        d.cancelicon[0] === !0 && a("#eData", "#" + r + "_2").addClass("right" === d.cancelicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='" + h.icon_base + " " + d.cancelicon[2] + "'></span>"),
                        a("#dData", "#" + r + "_2").click(function() {
                            var c, g = [!0, ""],
                            l = a("#DelData>td", "#" + r).text();
                            if (p = {},
                            a.isFunction(b[e.p.id].onclickSubmit) && (p = b[e.p.id].onclickSubmit.call(e, b[e.p.id], l) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (g = b[e.p.id].beforeSubmit.call(e, l)), g[0] && !b[e.p.id].processing) {
                                if (b[e.p.id].processing = !0, j = e.p.prmNames, f = a.extend({},
                                b[e.p.id].delData, p), k = j.oper, f[k] = j.deloper, i = j.id, l = String(l).split(","), !l.length) return ! 1;
                                for (c in l) l.hasOwnProperty(c) && (l[c] = a.jgrid.stripPref(e.p.idPrefix, l[c]));
                                f[i] = l.join(),
                                a(this).addClass(h.active);
                                var m = a.extend({
                                    ...
                                    complete: function(c, i) {
                                        var j;
                                        if (a("#dData", "#" + r + "_2").removeClass(h.active), c.status >= 300 && 304 !== c.status ? (g[0] = !1, g[1] = a.isFunction(b[e.p.id].errorTextFormat) ? b[e.p.id].errorTextFormat.call(e, c) : i + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (g = b[e.p.id].afterSubmit.call(e, c, f)), g[0] === !1) a("#DelError>td", "#" + r).html(g[1]),
                                        a("#DelError", "#" + r).show();
                                        else {
                                            if (b[e.p.id].reloadAfterSubmit && "local" !== e.p.datatype) a(e).trigger("reloadGrid");
                                                ...
                                                } catch(k) {} else for (j = 0; j < l.length; j++) a(e).jqGrid("delRowData", e.p.idPrefix + l[j]);
                                                e.p.selrow = null,
                                                e.p.selarrrow = []
                                            }
                                        ...
                                        g[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(t.themodal), {
                                ...
                                if (m.url || b[e.p.id].useDataProxy || (a.isFunction(e.p.dataProxy) ? b[e.p.id].useDataProxy = !0 : (g[0] = !1, g[1] += " " + a.jgrid.getRegional(e, "errors.nourl"))), g[0]) if (b[e.p.id].useDataProxy) {
                                    ...
                                    void 0 === n && (n = [!0, ""]),
                                    n[0] === !1 ? (g[0] = !1, g[1] = n[1] || "Error deleting the selected row!") : a.jgrid.hideModal("#" + a.jgrid.jqID(t.themodal), {
                                        gb: "#gbox_" + a.jgrid.jqID(o),
                                        jqm: d.jqModal,
                                        onClose: b[e.p.id].onClose
                                    })
                            ...
                            return g[0] === !1 && (a("#DelError>td", "#" + r).html(g[1]), a("#DelError", "#" + r).show()),
                            !1
                        }),
            ...
            this.each(function() {
                if (!this.p.navGrid) {
                    ...
                    if (p.grid && "string" == typeof b) {
                        a(p).data("navGrid") || a(p).data("navGrid", c),
                        n = a(p).data("navGrid"),
                        p.p.force_regional && (n = a.extend(n, i)),
                        void 0 === a("#" + o.themodal)[0] && (n.alerttop || n.alertleft || (void 0 !== window.innerWidth ? (n.alertleft = window.innerWidth, n.alerttop = window.innerHeight) : void 0 !== document.documentElement && void 0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (n.alertleft = document.documentElement.clientWidth, n.alerttop = document.documentElement.clientHeight) : (n.alertleft = 1024, n.alerttop = 768), n.alertleft = n.alertleft / 2 - parseInt(n.alertwidth, 10) / 2, n.alerttop = n.alerttop / 2 - 25), a.jgrid.createModal(o, "<div>" + n.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
                        ...
                        for (n.cloneToTop && p.p.toppager && (r = 2), q = 0; r > q; q++) {
                            var u, v, w, x = a("<table class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"),
                            y = "<td class='ui-pg-button " + l.disabled + "' style='width:4px;'><span class='ui-separator'></span></td>";
                            0 === q ? (v = b, w = p.p.id, v === p.p.toppager && (w += "_top", r = 1)) : (v = p.p.toppager, w = p.p.id + "_top"),
                            "rtl" === p.p.direction && a(x).attr("dir", "rtl").css("float", "right"),
                            e = e || {},
                            n.add && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.addicon + "'></span>" + n.addtext + "</div>"), a("tr", x).append(u), a(u, x).attr({
                                title: n.addtitle || "",
                                id: e.id || "add_" + w
                            }).click(function() {
                                return a(this).hasClass(l.disabled) || (a.isFunction(n.addfunc) ? n.addfunc.call(p) : a(p).jqGrid("editGridRow", "new", e)),
                                !1
                            }).hover(s, t), u = null),
                            d = d || {},
                            n.edit && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.editicon + "'></span>" + n.edittext + "</div>"), a("tr", x).append(u), a(u, x).attr({
                                title: n.edittitle || "",
                                id: d.id || "edit_" + w
                            }).click(function() {
                            ...
                            h = h || {},
                            n.view && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.viewicon + "'></span>" + n.viewtext + "</div>"), a("tr", x).append(u), a(u, x).attr({
                                title: n.viewtitle || "",
                                id: h.id || "view_" + w
                            }).click(function() {
                                if (!a(this).hasClass(l.disabled)) {
                            ...
                            f = f || {},
                            n.del && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.delicon + "'></span>" + n.deltext + "</div>"), a("tr", x).append(u), a(u, x).attr({
                                title: n.deltitle || "",
                                id: f.id || "del_" + w
                            }).click(function() {
                                if (!a(this).hasClass(l.disabled)) {
                                    ...
                                    b ? a.isFunction(n.delfunc) ? n.delfunc.call(p, b) : a(p).jqGrid("delGridRow", b, f) : (a.jgrid.viewModal("#" + o.themodal, {
                                        gbox: "#gbox_" + a.jgrid.jqID(p.p.id),
                                        jqm: !0
                                    }), a("#jqg_alrt").focus())
                                }
                            ...
                            (n.add || n.edit || n.del || n.view) && a("tr", x).append(y),
                            g = g || {},
                            n.search && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.searchicon + "'></span>" + n.searchtext + "</div>"), a("tr", x).append(u), a(u, x).attr({
                                title: n.searchtitle || "",
                                id: g.id || "search_" + w
                            }).click(function() {
                                return a(this).hasClass(l.disabled) || (a.isFunction(n.searchfunc) ? n.searchfunc.call(p, g) : a(p).jqGrid("searchGrid", g)),
                                !1
                            }).hover(s, t), g.showOnLoad && g.showOnLoad === !0 && a(u, x).click(), u = null),
                            n.refresh && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.refreshicon + "'></span>" + n.refreshtext + "</div>"), a("tr", x).append(u), a(u, x).attr({
                                title: n.refreshtitle || "",
                                id: "refresh_" + w
                            }).click(function() {
                                if (!a(this).hasClass(l.disabled)) {
                                    a.isFunction(n.beforeRefresh) && n.beforeRefresh.call(p),
                                    p.p.search = !1,
                                    p.p.resetsearch = !0;
                                    try {
                            ...
                            a("body").append("<div id='testpg2' class='ui-jqgrid " + a.jgrid.styleUI[j].base.entrieBox + "' style='font-size:" + m + ";visibility:hidden;' ></div>"),
                            k = a(x).clone().appendTo("#testpg2").width(),
                            a("#testpg2").remove(),
                            p.p._nvtd && (n.dropmenu ? (x = null, a(p).jqGrid("_buildNavMenu", v, w, c, d, e, f, g, h)) : k > p.p._nvtd[0] ? (p.p.responsive ? (x = null, a(p).jqGrid("_buildNavMenu", v, w, c, d, e, f, g, h)) : a(v + "_" + n.position, v).append(x).width(k), p.p._nvtd[0] = k) : a(v + "_" + n.position, v).append(x), p.p._nvtd[1] = k),
                            p.p.navGrid = !0
                        }
            ...
            this.each(function() {
                if (this.grid) {
                    ...
                    if (f.p.storeNavOptions && !c.internal && f.p.navButtons.push([b, c]), e) {
                        ...
                        var k = a("<td></td>");
                        a(k).addClass("ui-pg-button " + i).append("NONE" === c.buttonicon.toString().toUpperCase() ? "<div class='ui-pg-div'>" + c.caption + "</div>": "<div class='ui-pg-div'><span class='" + j + " " + c.buttonicon + "'></span>" + c.caption + "</div>"),
                        c.id && a(k).attr("id", c.id),
                        "first" === c.position ? 0 === e.rows[0].cells.length ? a("tr", e).append(k) : a("tr td:eq(0)", e).before(k) : a("tr", e).append(k),
                        a(k, e).attr("title", c.title || "").click(function(b) {
                            return a(this).hasClass(g) || a.isFunction(c.onClickButton) && c.onClickButton.call(f, b),
                            !1
                        }).hover(function() {
                        ...
                        l && ("first" === c.position ? a("#" + l).prepend(n) : a("#" + l).append(n), a(n).on("click",
                        function(b) {
                            return a(this).hasClass(g) || (a("#" + l).hide(), a.isFunction(c.onClickButton) && c.onClickButton.call(f, b)),
                            !1
        ...
        _buildNavMenu: function(b, c, d, e, f, g, h, i) {
            return this.each(function() {
                ...
                s = function() {
                    var b, k, l = a(".ui-jqgrid-view").css("font-size") || "11px",
                    p = a('<ul id="' + o + '" class="ui-nav-menu modal-content" role="menu" tabindex="0" style="display:none;font-size:' + l + '"></ul>');
                    d.add && (f = f || {},
                    b = f.id || "add_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.addtext || d.addtitle) + "</a></li>").click(function() {
                        return a(this).hasClass(n.disabled) || (a.isFunction(d.addfunc) ? d.addfunc.call(j) : a(j).jqGrid("editGridRow", "new", f), a(p).hide()),
                        !1
                    }), a(p).append(k)),
                    d.edit && (e = e || {},
                    b = e.id || "edit_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.edittext || d.edittitle) + "</a></li>").click(function() {
                    ...
                    d.view && (i = i || {},
                    b = i.id || "view_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.viewtext || d.viewtitle) + "</a></li>").click(function() {
                        if (!a(this).hasClass(n.disabled)) {
                            var b = j.p.selrow;
                    ...
                    d.del && (g = g || {},
                    b = g.id || "del_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.deltext || d.deltitle) + "</a></li>").click(function() {
                        if (!a(this).hasClass(n.disabled)) {
                            var b;
                            j.p.multiselect ? (b = j.p.selarrrow, 0 === b.length && (b = null)) : b = j.p.selrow,
                            b ? a.isFunction(d.delfunc) ? d.delfunc.call(j, b) : a(j).jqGrid("delGridRow", b, g) : (a.jgrid.viewModal("#" + r.themodal, {
                                gbox: "#gbox_" + a.jgrid.jqID(j.p.id),
                                jqm: !0
                            }), a("#jqg_alrt").focus()),
                            a(p).hide()
                    ...
                    (d.add || d.edit || d.del || d.view) && a(p).append("<li class='ui-menu-item " + n.disabled + "' style='width:100%' role='presentation'><hr class='ui-separator-li'></li>"),
                    d.search && (h = h || {},
                    b = h.id || "search_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.searchtext || d.searchtitle) + "</a></li>").click(function() {
                        return a(this).hasClass(n.disabled) || (a.isFunction(d.searchfunc) ? d.searchfunc.call(j, h) : a(j).jqGrid("searchGrid", h), a(p).hide()),
                        !1
                    }), a(p).append(k), h.showOnLoad && h.showOnLoad === !0 && a(k).click()),
                    d.refresh && (b = h.id || "search_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.refreshtext || d.refreshtitle) + "</a></li>").click(function() {
                        if (!a(this).hasClass(n.disabled)) {
                            a.isFunction(d.beforeRefresh) && d.beforeRefresh.call(j),
                            j.p.search = !1,
                            j.p.resetsearch = !0;
                            try {
                            ...
                            a.isFunction(d.afterRefresh) && d.afterRefresh.call(j),
                            a(p).hide()
                        }
                        return ! 1
                    }), a(p).append(k)),
                    a(p).hide(),
                    a("body").append(p),
                    a("#" + o).addClass("ui-menu " + m.menu_widget),
                    a("#" + o + " > li > a").hover(function() {
                ...
                s(),
                a(".dropdownmenu", b + "_" + d.position).on("click",
                function(b) {
                    var c = a(this).offset(),
                    d = c.left,
                    e = parseInt(c.top),
...
function(a) {
    ...
    a.fn.jqFilter = function(b) {
        ...
        return this.each(function() {
            if (!this.filter) {
                ...
                if (this.p.initFilter = a.extend(!0, {},
                this.p.filter), d) {
                    for (b = 0; d > b; b++) c = this.p.columns[b],
                    c.stype ? c.inputtype = c.stype: c.inputtype || (c.inputtype = "text"),
                    c.sorttype ? c.searchtype = c.sorttype: c.searchtype || (c.searchtype = "string"),
                    void 0 === c.hidden && (c.hidden = !1),
                    c.label || (c.label = c.name),
                    c.index && (c.name = c.index),
                    c.hasOwnProperty("searchoptions") || (c.searchoptions = {}),
                    c.hasOwnProperty("searchrules") || (c.searchrules = {});
                    var g = function() {
                    ...
                    this.onchange = function() {
                        ...
                        this.p.errmsg = "",
                        a.isFunction(this.p.onChange) ? this.p.onChange.call(this, this.p) : !1
                    },
                    ...
                    this.createTableForGroup = function(b, c) {
                        ...
                        null === c && g.append("<tr class='error' style='display:none;'><th colspan='5' class='" + j.error + "' align='" + h + "'></th></tr>");
                        var k = a("<tr></tr>");
                        g.append(k);
                        ...
                        if (k.append(l), this.p.ruleButtons === !0) {
                            ...
                            l.append(m);
                            var n, o = "";
                            for (d = 0; d < e.groupOps.length; d++) n = b.groupOp === f.p.groupOps[d].op ? " selected='selected'": "",
                            o += "<option value='" + f.p.groupOps[d].op + "'" + n + ">" + f.p.groupOps[d].text + "</option>";
                            m.append(o).bind("change",
                            function() {
                                b.groupOp = a(m).val(),
                                f.onchange()
                            })
                        ...
                        var p = "<span></span>";
                        if (this.p.groupButton && (p = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group " + j.button + "'/>"), p.bind("click",
                        function() {
                            return void 0 === b.groups && (b.groups = []),
                            b.groups.push({
                            ...
                            function() {
                                ...
                                var h;
                                return h = q.searchoptions.sopt ? q.searchoptions.sopt: f.p.sopt ? f.p.sopt: -1 !== a.inArray(q.searchtype, f.p.strarr) ? f.p.stropts: f.p.numopts,
                                b.rules.push({
                                    field: q.name,
                                    op: h[0],
                                    data: ""
                        ...
                        if (void 0 !== b.groups) for (d = 0; d < b.groups.length; d++) {
                            ...
                            v.append(this.createTableForGroup(b.groups[d], b)),
                            t.append(v)
                        }
                    ...
                    this.createTableRowForRule = function(b, c) {
                        ...
                        function() {
                            ...
                            if (l) {
                                l.searchoptions.id = a.jgrid.randId(),
                                l.searchoptions.name = b.field,
                                l.searchoptions.oper = "filter",
                                f && "text" === l.inputtype && (l.searchoptions.size || (l.searchoptions.size = 10));
                                var c = a.jgrid.createEl.call(o, l.inputtype, l.searchoptions, "", !0, n.p.ajaxSelectOptions || {},
                                !0);
                                a(c).addClass("input-elm " + i.srInput),
                                h = l.searchoptions.sopt ? l.searchoptions.sopt: n.p.sopt ? n.p.sopt: -1 !== a.inArray(l.searchtype, n.p.strarr) ? n.p.stropts: n.p.numopts;
                                var e = "",
                                g = 0;
                                for (u = [], a.each(n.p.ops,
                                function() {
                                    u.push(this.oper)
                                }), d = 0; d < h.length; d++) s = a.inArray(h[d], u),
                                -1 !== s && (0 === g && (b.op = n.p.ops[s].oper), e += "<option value='" + n.p.ops[s].oper + "'>" + n.p.ops[s].text + "</option>", g++);
                                if (a(".selectopts", k).empty().append(e), a(".selectopts", k)[0].selectedIndex = 0, a.jgrid.msie && a.jgrid.msiever() < 9) {
                                    ...
                                    a(".selectopts", k).width(j),
                                    a(".selectopts", k).css("width", "auto")
                                }
                                a(".data", k).append(c),
                                a.jgrid.bindEv.call(o, c, l.searchoptions),
                                a(".input-elm", k).bind("change",
                                function(c) {
                                    var d = c.target;
                                    b.data = "SPAN" === d.nodeName.toUpperCase() && l.searchoptions && a.isFunction(l.searchoptions.custom_value) ? l.searchoptions.custom_value.call(o, a(d).children(".customelement:first"), "get") : d.value,
                                    n.onchange()
                                }),
                                setTimeout(function() {
                                    b.data = a(c).val(),
                        ...
                        for (d = 0; d < n.p.columns.length; d++) {
                            ...
                            y = n.p.columns[d].searchoptions.searchhidden === !0; (y && w || w && !x) && (m = "", b.field === n.p.columns[d].name && (m = " selected='selected'", v = d), q += "<option value='" + n.p.columns[d].name + "'" + m + ">" + n.p.columns[d].label + "</option>")
                        }
                        t.append(q);
                        ...
                        l.searchoptions.name = b.field,
                        l.searchoptions.oper = "filter";
                        var A = a.jgrid.createEl.call(o, l.inputtype, l.searchoptions, b.data, !0, n.p.ajaxSelectOptions || {},
                        !0); ("nu" === b.op || "nn" === b.op) && (a(A).attr("readonly", "true"), a(A).attr("disabled", "true"));
                        var B = a("<select class='selectopts " + i.srSelect + "'></select>");
                        for (z.append(B), B.bind("change",
                        function() {
                            b.op = a(B).val(),
                            k = a(this).parents("tr:first");
                            ...
                            n.onchange()
                        }), h = l.searchoptions.sopt ? l.searchoptions.sopt: n.p.sopt ? n.p.sopt: -1 !== a.inArray(l.searchtype, n.p.strarr) ? n.p.stropts: n.p.numopts, q = "", a.each(n.p.ops,
                        function() {
                            u.push(this.oper)
                        }), d = 0; d < h.length; d++) s = a.inArray(h[d], u),
                        -1 !== s && (m = b.op === n.p.ops[s].oper ? " selected='selected'": "", q += "<option value='" + n.p.ops[s].oper + "'" + m + ">" + n.p.ops[s].text + "</option>");
                        B.append(q);
                        var C = a("<td class='data'></td>");
                        p.append(C),
                        C.append(A),
                        a.jgrid.bindEv.call(o, A, l.searchoptions),
                        a(A).addClass("input-elm " + i.srInput).bind("change",
                        function() {
                            b.data = "custom" === l.inputtype ? l.searchoptions.custom_value.call(o, a(this).children(".customelement:first"), "get") : a(this).val(),
                            n.onchange()
                        });
                        var D = a("<td></td>");
                    ...
                    this.getStringForRule = function(b) {
                        ...
                        for (c = 0; c < this.p.ops.length; c++) if (this.p.ops[c].oper === b.op) {
                            h = this.p.operands.hasOwnProperty(b.op) ? this.p.operands[b.op] : "",
                            i = this.p.ops[c].oper;
                            break
                        }
                    ...
                    this.hideError = function() {
                        a("th." + j.error, this).html(""),
                        a("tr.error", this).hide()
                    },
                    this.showError = function() {
                        a("th." + j.error, this).html(this.p.errmsg),
    ...
    a.jgrid.extend({
        filterToolbar: function(b) {
            ...
            this.each(function() {
                ...
                if (!d.p.filterToolbar) {
                    ...
                    var e, f, g, h = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].filter,
                    ...
                    k = function() {
                        ...
                        var n = "stop" === a(d).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1; ! n && a.isFunction(b.beforeSearch) && (n = b.beforeSearch.call(d)),
                        n || a(d).jqGrid("setGridParam", {
                            search: j
                        }).trigger("reloadGrid", [{
                            page: 1
                        }]),
                        ...
                        a.isFunction(b.afterSearch) && b.afterSearch.call(d)
                    },
                    l = function(c) {
                        var e, f = {},
                        g = 0;
                        ...
                        var l = "stop" === a(d).triggerHandler("jqGridToolbarBeforeClear") ? !0 : !1; ! l && a.isFunction(b.beforeClear) && (l = b.beforeClear.call(d)),
                        l || c && a(d).jqGrid("setGridParam", {
                            search: h
                        }).trigger("reloadGrid", [{
                            page: 1
                        }]),
                    ...
                    n = function(c, e, f) {
                        ...
                        var s = d.p.colModel[p],
                        t = a.extend({},
                        s.searchoptions);
                        for (t.sopt || (t.sopt = [], t.sopt[0] = "select" === s.stype ? "eq": b.defaultSearch), a.each(b.odata,
                        function() {
                            o.push(this.oper)
                        }), p = 0; p < t.sopt.length; p++) j = a.inArray(t.sopt[p], o),
                        -1 !== j && (g = n === b.odata[j].oper ? i.highlight: "", m += '<li class="ui-menu-item ' + g + '" role="presentation"><a class="' + i.cornerall + ' g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[j].oper + '" oper="' + b.operands[b.odata[j].oper] + '"><table class="ui-common-table"><tr><td width="25px">' + b.operands[b.odata[j].oper] + "</td><td>" + b.odata[j].text + "</td></tr></table></a></li>");
                        m += "</ul>",
                        a("body").append(m),
                        a("#sopt_menu").addClass("ui-menu " + h.menu_widget),
                        ...
                        function() {
                            ...
                            if (a(d).triggerHandler("jqGridToolbarSelectOper", [e, f, c]), a("#sopt_menu").hide(), a(c).text(f).attr("soper", e), b.autosearch === !0) {
                                var g = a(c).parent().next().children()[0]; (a(g).val() || "nu" === e || "nn" === e) && k()
                            }
                        })
                    },
                    o = a("<tr class='ui-search-toolbar' role='row'></tr>");
                    b.restoreFromFilters && (g = d.p.postData.filters, g && ("string" == typeof g && (g = a.jgrid.parse(g)), f = g.rules.length ? g.rules: !1)),
                    a.each(d.p.colModel,
                    function(c) {
                        var g, i, l, m, n, p, q, r, s = this,
                        t = "",
                        u = "=",
                        ...
                        if (this.hidden === !0 && a(v).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), g = a.extend({},
                        this.searchoptions || {},
                        {
                            name: s.index || s.name,
                        ...
                        a(v).append(w),
                        a(o).append(v),
                        b.searchOperators || a("td:eq(0)", x).hide()
                    }),
                    a("table thead", d.grid.hDiv).append(o),
                    b.searchOperators && (a(".soptclass", o).click(function(b) {
                        var c = a(this).offset(),
                        d = c.left,
                        e = c.top;
                        n(this, d, e),
                    ...
                    a(".clearsearchclass", o).click(function() {
                        ...
                        f = a.extend({},
                        d.p.colModel[e].searchoptions || {}),
                        g = f.defaultValue ? f.defaultValue: "";
                        "select" === d.p.colModel[e].stype ? g ? a("td.ui-search-input select", c).val(g) : a("td.ui-search-input select", c)[0].selectedIndex = 0 : a("td.ui-search-input input", c).val(g),
                        b.autosearch === !0 && k()
                    }),
                    this.p.filterToolbar = !0,
                    this.triggerToolbar = k,
                    this.clearToolbar = l,
                    this.toggleToolbar = m
                }
            })
        },
        ...
        searchGrid: function(b) {
            ...
            this.each(function() {
                function c(c) {
                    g = a(d).triggerHandler("jqGridFilterBeforeShow", [c]),
                    void 0 === g && (g = !0),
                    g && a.isFunction(b.beforeShowSearch) && (g = b.beforeShowSearch.call(d, c)),
                    g && (a.jgrid.viewModal("#" + a.jgrid.jqID(i.themodal), {
                ...
                if (d.grid) {
                    ...
                    if (b.styleUI = d.p.styleUI, "string" == typeof j && (j = a.jgrid.parse(j)), b.recreateFilter === !0 && a("#" + a.jgrid.jqID(i.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(i.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(d.p.id)));
                        ...
                        var m = a("<div><div id='" + f + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + a.jgrid.jqID(d.p.id)),
                        n = "left",
                        o = "";
                        "rtl" === d.p.direction && (n = "right", o = " style='text-align:left'", m.attr("dir", "rtl"));
                        var p, q, r = a.extend([], d.p.colModel),
                        ...
                        w = !1,
                        x = -1;
                        if (b.showQuery && (u = "<a id='" + f + "_query' class='fm-button " + l.button + " fm-button-icon-left'><span class='" + l.icon_base + " " + k.icon_query + "'></span>Query</a>"), b.columns.length ? (r = b.columns, x = 0, p = r[0].index || r[0].name) : a.each(r,
                        function(a, b) {
                            if (b.label || (b.label = d.p.colNames[a]), !w) {
                                var c = void 0 === b.search ? !0 : b.search,
                                e = b.hidden === !0,
                                f = b.searchoptions && b.searchoptions.searchhidden === !0; (f && c || c && !e) && (w = !0, p = b.index || b.name, x = a)
                            }
                        }), !j && p || b.multipleSearch === !1) {
                            var y = "eq";
                            x >= 0 && r[x].searchoptions && r[x].searchoptions.sopt ? y = r[x].searchoptions.sopt[0] : b.sopt && b.sopt.length && (y = b.sopt[0]),
                            j = {
                                groupOp: "AND",
                                rules: [{
                                    field: p,
                        ...
                        w = !1,
                        b.tmplNames && b.tmplNames.length && (w = !0, v = "<tr><td class='ui-search-label'>" + b.tmplLabel + "</td>", v += "<td><select class='ui-template " + k.srSelect + "'>", v += "<option value='default'>Default</option>", a.each(b.tmplNames,
                        function(a, b) {
                            v += "<option value='" + a + "'>" + b + "</option>"
                        }), v += "</select></td></tr>"),
                        q = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + f + "_2'><tbody><tr><td colspan='2'><hr class='" + l.content + "' style='margin:1px'/></td></tr>" + v + "<tr><td class='EditButton' style='text-align:" + n + "'>" + t + "</td><td class='EditButton' " + o + ">" + u + s + "</td></tr></tbody></table>",
                        f = a.jgrid.jqID(f),
                        a("#" + f).jqFilter({
                            columns: r,
                            ...
                            onChange: function() {
                                ...
                                a.isFunction(b.afterChange) && b.afterChange.call(d, a("#" + f), b)
                            },
                            direction: d.p.direction,
                            id: d.p.id
                        }),
                        m.append(q),
                        w && b.tmplFilters && b.tmplFilters.length && a(".ui-template", m).bind("change",
                        function() {
                            var c = a(this).val();
                            return "default" === c ? a("#" + f).jqFilter("addFilter", j) : a("#" + f).jqFilter("addFilter", b.tmplFilters[parseInt(c, 10)]),
                            !1
                        }),
                        b.multipleGroup === !0 && (b.multipleSearch = !0),
                        a(d).triggerHandler("jqGridFilterInitialize", [a("#" + f)]),
                        a.isFunction(b.onInitializeSearch) && b.onInitializeSearch.call(d, a("#" + f)),
                        b.gbox = "#gbox_" + f,
                        b.layer ? a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
                            position: "relative"
                        }) : a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0]),
                        (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(i.themodal)).keydown(function(c) {
                            var d = a(c.target);
                        ...
                        u && a("#" + f + "_query").bind("click",
                        function() {
                            return a(".queryresult", m).toggle(),
                            !1
                        }),
                        ...
                        function() {
                            var c, g, j = {};
                            if (e = a("#" + f), e.find(".input-elm:focus").change(), g = e.jqFilter("filterData"), b.errorcheck && (e[0].hideError(), b.showQuery || e.jqFilter("toSQLString"), e[0].p.error)) return e[0].showError(),
                            !1;
                            if (b.stringResult) {
                                try {
                                    c = JSON.stringify(g)
                                } catch(k) {}
                                "string" == typeof c && (j[b.sFilter] = c, a.each([b.sField, b.sValue, b.sOper],
                                function() {
                                    j[this] = ""
                                }))
                            } else b.multipleSearch ? (j[b.sFilter] = g, a.each([b.sField, b.sValue, b.sOper],
                            function() {
                                j[this] = ""
                            })) : (j[b.sField] = g.rules[0].field, j[b.sValue] = g.rules[0].data, j[b.sOper] = g.rules[0].op, j[b.sFilter] = "");
                            return d.p.search = !0,
                            a.extend(d.p.postData, j),
                            h = a(d).triggerHandler("jqGridFilterSearch"),
                            void 0 === h && (h = !0),
                            h && a.isFunction(b.onSearch) && (h = b.onSearch.call(d, d.p.filters)),
                            h !== !1 && a(d).trigger("reloadGrid", [{
                                page: 1
                            }]),
                        ...
                        function() {
                            ...
                            return d.p.search = !1,
                            d.p.resetsearch = !0,
                            b.multipleSearch === !1 ? c[b.sField] = c[b.sValue] = c[b.sOper] = "": c[b.sFilter] = "",
                            e[0].resetFilter(),
                            w && a(".ui-template", m).val("default"),
                            a.extend(d.p.postData, c),
                            h = a(d).triggerHandler("jqGridFilterReset"),
                            void 0 === h && (h = !0),
                            h && a.isFunction(b.onReset) && (h = b.onReset.call(d)),
                            h !== !1 && a(d).trigger("reloadGrid", [{
                                page: 1
                            }]),
                        ...
                        c(a("#" + f)),
                        a(".fm-button:not(." + l.disabled + ")", m).hover(function() {
...
function(a) {
    ...
    a.jgrid.extend({
        editRow: function(b, c, d, e, f, g, h, i, j) {
            ...
            return "object" === a.type(l[0]) ? k = l[0] : (void 0 !== c && (k.keys = c), a.isFunction(d) && (k.oneditfunc = d), a.isFunction(e) && (k.successfunc = e), void 0 !== f && (k.url = f), void 0 !== g && (k.extraparam = g), a.isFunction(h) && (k.aftersavefunc = h), a.isFunction(i) && (k.errorfunc = i), a.isFunction(j) && (k.afterrestorefunc = j)),
            k = a.extend(!0, {
                keys: !1,
                keyevent: "keydown",
                oneditfunc: null,
            ...
            this.each(function() {
                ...
                i.grid && (f = a(i).jqGrid("getInd", b, !0), f !== !1 && (h = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(i, k, b) : void 0, void 0 === h && (h = !0), h && (e = a(f).attr("editable") || "0", "0" !== e || a(f).hasClass("not-editable-row") || (g = i.p.colModel, a('td[role="gridcell"]', f).each(function(e) {
                    ...
                    if ("cb" !== c && "subgrid" !== c && "rn" !== c && (i.p.autoencode && (d = a.jgrid.htmlDecode(d)), m[c] = d, g[e].editable === !0)) {
                        ...
                        ("&nbsp;" === d || "&#160;" === d || 1 === d.length && 160 === d.charCodeAt(0)) && (d = "");
                        var o = a.jgrid.createEl.call(i, g[e].edittype, k, d, !0, a.extend({},
                        a.jgrid.ajaxOptions, i.p.ajaxSelectOptions || {}));
                        a(o).addClass("editable inline-edit-cell"),
                        a.inArray(g[e].edittype, ["text", "textarea", "password", "select"]) > -1 && a(o).addClass(n),
                        f ? a("span:first", this).append(o) : a(this).append(o),
                        a.jgrid.bindEv.call(i, o, k),
                        "select" === g[e].edittype && void 0 !== g[e].editoptions && g[e].editoptions.multiple === !0 && void 0 === g[e].editoptions.dataUrl && a.jgrid.msie && a(o).width(a(o).width()),
                        j++
                    }
                ...
                0)), k.keys === !0 && a(f).bind(k.keyevent,
                function(c) {
                    if (27 === c.keyCode) {
        ...
        saveRow: function(b, c, d, e, f, g, h) {
            ...
            var w = a.jgrid.getRegional(this, "errors"),
            x = a.jgrid.getRegional(this, "edit"),
            y = a.isFunction(j.beforeSaveRow) ? j.beforeSaveRow.call(k, j, b) : void 0;
            if (void 0 === y && (y = !0), y) {
                if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
                    ...
                    if (a('td[role="gridcell"]', p).each(function(b) {
                        if (z = k.p.colModel[b], l = z.name, "cb" !== l && "subgrid" !== l && z.editable === !0 && "rn" !== l && !a(this).hasClass("not-editable-cell")) {
                            ...
                            case "checkbox":
                                ...
                                r[l] = a("input", this).is(":checked") ? c[0] : c[1];
                                break;
                            case "text":
                            case "password":
                            case "textarea":
                            ...
                            case "select":
                                if (z.editoptions.multiple) {
                                    ...
                                    s[l] = e.join(",")
                                } else r[l] = a("select option:selected", this).val(),
                                s[l] = a("select option:selected", this).text();
                            ...
                            k.p.autoencode && (r[l] = a.jgrid.htmlEncode(r[l])),
                            "clientArray" !== j.url && z.editoptions && z.editoptions.NullIfEmpty === !0 && "" === r[l] && (t[l] = "null", u = !0)
                        }
                    }), o[0] === !1) {
                        try {
                            var A = a(k).jqGrid("getGridRowById", b),
                            B = a.jgrid.findPos(A);
                    ...
                    var D, E = k.p.prmNames,
                    F = b;
                    if (D = k.p.keyName === !1 ? E.id: k.p.keyName, r) {
                        if (r[E.oper] = E.editoper, void 0 === r[D] || "" === r[D]) r[D] = b;
                        ...
                        void 0 === k.p.inlineData && (k.p.inlineData = {}),
                        r = a.extend({},
                        r, k.p.inlineData, j.extraparam)
                    }
                    if ("clientArray" === j.url) {
                        r = a.extend({},
                        r, s),
                        k.p.autoencode && a.each(r,
                        function(b, c) {
                        ...
                        n >= 0 && k.p.savedRow.splice(n, 1),
                        a(k).triggerHandler("jqGridInlineAfterSaveRow", [b, K, r, j]),
                        a.isFunction(j.aftersavefunc) && j.aftersavefunc.call(k, b, K, r, j),
                        q = !0,
                        a(p).removeClass("jqgrid-new-row").unbind("keydown")
                    ...
                    t = a.extend({},
                    r, t),
                    t[D] = a.jgrid.stripPref(k.p.idPrefix, t[D]),
                    a.ajax(a.extend({
                        url: j.url,
                        ...
                        complete: function(c, d) {
                            if (a(k).jqGrid("progressBar", {
                                ...
                                if (e = a(k).triggerHandler("jqGridInlineSuccessSaveRow", [c, b, j]), a.isArray(e) || (e = [!0, t]), e[0] && a.isFunction(j.successfunc) && (e = j.successfunc.call(k, c)), a.isArray(e) ? (g = e[0], r = e[1] || r) : g = e, g === !0) {
                                    ...
                                    r, s), a(k).jqGrid("setRowData", b, r), a(p).attr("editable", "0"), f = 0; f < k.p.savedRow.length; f++) if (String(k.p.savedRow[f].id) === String(b)) {
                                        n = f;
                                        break
                                    }
                                    n >= 0 && k.p.savedRow.splice(n, 1),
                                    a(k).triggerHandler("jqGridInlineAfterSaveRow", [b, c, r, j]),
                                    a.isFunction(j.aftersavefunc) && j.aftersavefunc.call(k, b, c, r, j),
                                    q = !0,
                                    a(p).removeClass("jqgrid-new-row").unbind("keydown")
                                } else a(k).triggerHandler("jqGridInlineErrorSaveRow", [b, c, d, null, j]),
                                a.isFunction(j.errorfunc) && j.errorfunc.call(k, b, c, d, null),
        ...
        restoreRow: function(b, c) {
            var d = a.makeArray(arguments).slice(1),
            e = {};
            return "object" === a.type(d[0]) ? e = d[0] : a.isFunction(c) && (e.afterrestorefunc = c),
            e = a.extend(!0, {},
                ...
                if (f.grid && (c = a(f).jqGrid("getInd", b, !0), c !== !1)) {
                    ...
                    if (void 0 === i && (i = !0), i) {
                        ...
                        if (g >= 0) {
                            ...
                            f.p.savedRow.splice(g, 1),
                            a("#" + a.jgrid.jqID(b), "#" + a.jgrid.jqID(f.p.id)).hasClass("jqgrid-new-row") && setTimeout(function() {
                                a(f).jqGrid("delRowData", b),
                                a(f).jqGrid("showAddEditButtons")
                            },
                            0)
                        }
                        a(f).triggerHandler("jqGridInlineAfterRestoreRow", [b]),
                        a.isFunction(e.afterrestorefunc) && e.afterrestorefunc.call(f, b)
                    }
                }
            })
        },
            ...
            this.each(function() {
                if (this.grid) {
                    ...
                    if (void 0 === d && (d = !0), d) if (b.rowID = a.isFunction(b.rowID) ? b.rowID.call(c, b) : null != b.rowID ? b.rowID: a.jgrid.randId(), b.useDefValues === !0 && a(c.p.colModel).each(function() {
                        ...
                        var e = c.p.prmNames,
                        f = e.oper;
                        b.addRowParams.extraparam[f] = e.addoper,
                ...
                if (this.grid && !this.p.inlineNav) {
                    ...
                    c.add && a(d).jqGrid("navButtonAdd", b, {
                        ...
                        onClickButton: function() {
                            ...
                            c.addParams.useFormatter || (a("#" + f + "_ilsave").removeClass(g), a("#" + f + "_ilcancel").removeClass(g), a("#" + f + "_iladd").addClass(g), a("#" + f + "_iledit").addClass(g))
                        }
                    }),
                    ...
                    c.save && (a(d).jqGrid("navButtonAdd", b, {
                        ...
                        onClickButton: function() {
                            ...
                            if (b) {
                                ...
                                g = e.oper,
                                h = c.editParams;
                                a("#" + a.jgrid.jqID(b), "#" + f).hasClass("jqgrid-new-row") ? (c.addParams.addRowParams.extraparam[g] = e.addoper, h = c.addParams.addRowParams) : (c.editParams.extraparam || (c.editParams.extraparam = {}), c.editParams.extraparam[g] = e.editoper),
                                a(d).jqGrid("saveRow", b, h) && a(d).jqGrid("showAddEditButtons")
                    ...
                    }), a("#" + f + "_ilcancel").addClass(g)),
                    c.restoreAfterSelect === !0 && a(d).bind("jqGridBeforeSelectRow.inlineNav",
                    function(b, e) {
            ...
            return this.each(function() {
                ...
                if (i.grid && i.p.cellEdit === !0) {
                    ...
                    if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
                        if (g = a("td:eq(" + c + ")", i.rows[b]), h.editable !== !0 || d !== !0 || g.hasClass("not-editable-cell") || a.isFunction(i.p.isCellEditable) && !i.p.isCellEditable.call(i, e, b, c)) parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && a(i.rows[i.p.iRow]).removeClass("selected-row " + k).find("td:eq(" + i.p.iCol + ")").removeClass("edit-cell " + j),
                        g.addClass("edit-cell " + j),
                        a(i.rows[b]).addClass("selected-row " + k),
                        ...
                        a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c);
                            ...
                            parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && a(i.rows[i.p.iRow]).removeClass("selected-row " + k).find("td:eq(" + i.p.iCol + ")").removeClass("edit-cell " + j),
                            a(g).addClass("edit-cell " + j),
                            a(i.rows[b]).addClass("selected-row " + k);
                            try {
                            ...
                            p = a.jgrid.createEl.call(i, h.edittype, o, f, !0, a.extend({},
                            a.jgrid.ajaxOptions, i.p.ajaxSelectOptions || {}));
                            a.inArray(h.edittype, ["text", "textarea", "password", "select"]) > -1 && a(p).addClass(l),
                            a(g).html("").append(p).attr("tabindex", "0"),
                            a.jgrid.bindEv.call(i, p, o),
                            ...
                            function(d) {
                                if (27 === d.keyCode && (a("input.hasDatepicker", g).length > 0 ? a(".ui-datepicker").is(":hidden") ? a(i).jqGrid("restoreCell", b, c) : a("input.hasDatepicker", g).datepicker("hide") : a(i).jqGrid("restoreCell", b, c)), 13 === d.keyCode && !d.shiftKey) return a(i).jqGrid("saveCell", b, c),
                                !1;
                                if (9 === d.keyCode) {
                    ...
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        ...
                        case "select":
                            if (k.editoptions.multiple) {
                                var o = a("#" + b + "_" + m, e.rows[b]),
                                p = [];
                                h = a(o).val(),
                                h ? h.join(",") : h = "",
                                a("option:selected", o).each(function(b, c) {
                                    p[b] = a(c).text()
                                }),
                                i = p.join(",")
                            } else h = a("#" + b + "_" + m + " option:selected", e.rows[b]).val(),
                            i = a("#" + b + "_" + m + " option:selected", e.rows[b]).text();
                            k.formatter && (i = h);
                            break;
                        case "checkbox":
                            var q = ["Yes", "No"];
                            k.editoptions && (q = k.editoptions.value.split(":")),
                            h = a("#" + b + "_" + m, e.rows[b]).is(":checked") ? q[0] : q[1],
                            i = h;
                            break;
                        case "password":
                        case "text":
                        ...
                        if (i !== e.p.savedRow[d].v) {
                            ...
                            if (u[0] === !0) {
                                ...
                                if (a.isFunction(e.p.beforeSubmitCell) && (v = e.p.beforeSubmitCell.call(e, e.rows[b].id, l, h, b, c), v || (v = {})), a("input.hasDatepicker", j).length > 0 && a("input.hasDatepicker", j).datepicker("hide"), "remote" === e.p.cellsubmit) if (e.p.cellurl) {
                                    var w = {};
                                    e.p.autoencode && (h = a.jgrid.htmlEncode(h)),
                                    w[l] = h;
                                    var x, y, z;
                                    z = e.p.prmNames,
                                    x = z.id,
                                    y = z.oper,
                                    w[x] = a.jgrid.stripPref(e.p.idPrefix, e.rows[b].id),
                                    w[y] = z.editoper,
                                    w = a.extend(v, w),
                                    ...
                                    a.ajax(a.extend({
                                        ...
                                        error: function(d, h, i) {
                                            ...
                                            a(e).triggerHandler("jqGridErrorCell", [d, h, i]),
                                            a.isFunction(e.p.errorCell) ? e.p.errorCell.call(e, d, h, i) : a.jgrid.info_dialog(f.errcap, d.status + " : " + d.statusText + "<br/>" + h, g.bClose, {
                                                styleUI: e.p.styleUI
                                            }),
                                            e.p.restoreCellonFail && a(e).jqGrid("restoreCell", b, c)
                                        }
    ...
    a.jqm = {
        ...
        open: function(b, g) {
            ...
            1), d.push(b)) : j.overlay > 0 ? j.closeoverlay && i.w.jqmAddClose(m) : m = e, i.o = m ? m.addClass(j.overlayClass).prependTo("body") : e, j.ajax) {
                var n = j.target || i.w,
                o = j.ajax;
                n = "string" == typeof n ? a(n, i.w) : a(n),
                o = "@" === o.substr(0, 1) ? a(g).attr(o.substring(1)) : o,
                n.html(j.ajaxText).load(o,
                function() {
                    j.onLoad && j.onLoad.call(this, i),
                    k && i.w.jqmAddClose(a(k, i.w)),
                    f(i)
                })
            } else k && i.w.jqmAddClose(a(k, i.w));
            return j.toTop && i.o && i.w.before('<span id="jqmP' + i.w[0]._jqm + '"></span>').insertAfter(i.o),
            j.onShow ? j.onShow(i) : i.w.show(),
            f(i),
            e
        },
        close: function(b) {
    ...
    g = function(d, g, j, k) {
        return d.each(function() {
            ...
            function(d) {
                ...
                return a(document).mousemove(a.jqDnR.drag).mouseup(a.jqDnR.stop),
                !1
            })
        })
    },
...
function(a) {
    ...
    a.jgrid.extend({
        ...
        addSubGridCell: function(b, c) {
            var d, e, f, g = "";
            return this.each(function() {
                g = this.formatCol(b, c),
                e = this.p.id,
                d = this.p.subGridOptions.plusicon,
                f = a.jgrid.styleUI[this.p.styleUI || "jQueryUI"].common
            }),
            ...
            return this.each(function() {
                ...
                if (d.grid) {
                    ...
                    m = function(b, c) {
                        ...
                        i = a("<tr></tr>");
                        for (f = 0; f < d.p.subGridModel[0].name.length; f++) e = a("<th class='" + j.headerBox + " ui-th-subgrid ui-th-column ui-th-" + d.p.direction + "'></th>"),
                        a(e).html(d.p.subGridModel[0].name[f]),
                        a(e).width(d.p.subGridModel[0].width[f]),
                        a(i).append(e);
                        a(h).append(i),
                        ...
                        return a("#" + a.jgrid.jqID(m + c)).append(h),
                        d.grid.hDiv.loading = !1,
                    ...
                    n = function(b, c) {
                        ...
                        o = a("<tr></tr>");
                        for (g = 0; g < d.p.subGridModel[0].name.length; g++) e = a("<th class='" + j.headerBox + " ui-th-subgrid ui-th-column ui-th-" + d.p.direction + "'></th>"),
                        a(e).html(d.p.subGridModel[0].name[g]),
                        a(e).width(d.p.subGridModel[0].width[g]),
                        a(o).append(e);
                        if (a(n).append(o), b && (i = d.p.jsonReader.subgrid, f = a.jgrid.getAccessor(b, i.root), void 0 !== f)) for (g = 0; g < f.length; g++) {
                            if (h = f[g], o = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), i.repeatitems === !0) for (i.cell && (h = h[i.cell]), m = 0; m < h.length; m++) l(o, h[m] || "&#160;", m);
                            else {
                        ...
                        return a("#" + a.jgrid.jqID(q + c)).append(n),
                        d.grid.hDiv.loading = !1,
                        a("#load_" + a.jgrid.jqID(d.p.id)).hide(),
                        !1
                    },
                    o = function(b) {
                        ...
                        case "json":
                            a.ajax(a.extend({
                                ...
                                complete: function(b) {
                                    "xml" === d.p.subgridtype ? m(b.responseXML, c) : n(a.jgrid.parse(b.responseText), c),
                                    b = null
                                }
                            },
                    ...
                    p = 0;
                    a.each(d.p.colModel,
                    function() { (this.hidden === !0 || "rn" === this.name || "cb" === this.name) && p++
                    });
                    var q = d.rows.length,
                    r = 1;
                    for (void 0 !== c && c > 0 && (r = c, q = c + 1); q > r;) a(d.rows[r]).hasClass("jqgrow") && (d.p.scroll && a(d.rows[r].cells[b]).unbind("click"), a(d.rows[r].cells[b]).bind("click",
                    function() {
                        ...
                        if (f = d.p.id, e = c.id, i = a("#" + f + "_" + e + "_expandedContent"), a(this).hasClass("sgcollapsed")) {
                            ...
                            d.p.subGridOptions.reloadOnExpand === !0 ? i.remove(".ui-subgrid") : i.hasClass("ui-subgrid") && i.hide().addClass("ui-sg-collapsed").removeClass("ui-sg-expanded"),
                            a(this).html("<a style='cursor:pointer;' class='ui-sghref'><span class='" + k.icon_base + " " + d.p.subGridOptions.plusicon + "'></span></a>").removeClass("sgexpanded").addClass("sgcollapsed"),
                            d.p.subGridOptions.selectOnCollapse && a(d).jqGrid("setSelection", e)
                        }
                        return ! 1
                    })),
                    r++;
    ...
    a.jgrid.extend({
        groupingSetup: function() {
            return this.each(function() {
                ...
                if (null === g || "object" != typeof g && !a.isFunction(g)) e.p.grouping = !1;
                    ...
                    for (void 0 === g.visibiltyOnNextGrouping && (g.visibiltyOnNextGrouping = []), g.lastvalues = [], g._locgr || (g.groups = []), g.counters = [], b = 0; b < g.groupField.length; b++) g.groupOrder[b] || (g.groupOrder[b] = "asc"),
                    g.groupText[b] || (g.groupText[b] = "{0}"),
                    "boolean" != typeof g.groupColumnShow[b] && (g.groupColumnShow[b] = !0),
                    "boolean" != typeof g.groupSummary[b] && (g.groupSummary[b] = !1),
                    g.groupSummaryPos[b] || (g.groupSummaryPos[b] = "footer"),
                    g.groupColumnShow[b] === !0 ? (g.visibiltyOnNextGrouping[b] = !0, a(e).jqGrid("showCol", g.groupField[b])) : (g.visibiltyOnNextGrouping[b] = a("#" + a.jgrid.jqID(e.p.id + "_" + g.groupField[b])).is(":visible"), a(e).jqGrid("hideCol", g.groupField[b]));
        ...
        groupingPrepare: function(b, c) {
            return this.each(function() {
                ...
                m = 0;
                for (d = 0; l > d; d++) e = i.groupField[d],
                g = i.displayField[d],
                f = b[e],
                h = null == g ? null: b[g],
                null == h && (h = f),
                void 0 !== f && (0 === c ? (i.groups.push({
                    idx: d,
                    dataIndex: e,
                    value: f,
                    displayValue: h,
            ...
            return this.each(function() {
                ...
                if (n.hasClass(j)) {
                    if (d.showSummaryOnHide) {
                        if (m) for (; m && (g = o(m.className), !(void 0 !== g && f >= g));) a(m).hide(),
                        m = m.nextSibling,
                        r && (a(t).hide(), t = t.nextSibling)
                    } else if (m) for (; m && (g = o(m.className), !(void 0 !== g && f >= g));) a(m).hide(),
                    m = m.nextSibling,
                    r && (a(t).hide(), t = t.nextSibling);
                ...
                a(c).triggerHandler("jqGridGroupingClickGroup", [b, p]),
                a.isFunction(c.p.onClickGroup) && c.p.onClickGroup.call(c, b, p)
            }),
            !1
        },
            ...
            return this.each(function() {
                ...
                function g(b, d, e, g) {
                    ...
                    for (i = g; c > i; i++) {
                        ...
                        function() {
                            if (this.nm === l[i].name) {
                                l[i].summaryTpl && (p = l[i].summaryTpl),
                                ...
                                try {
                                    ...
                                    h = k.formatter("", this.v, i, this)
                                } catch(b) {
                                    h = this.v
                                }
                                return o = "<td " + k.formatCol(i, 1, "") + ">" + a.jgrid.template(p, h) + "</td>",
                                !1
                            }
                        }),
                        n += o
                ...
                u.reverse(),
                s = k.p.multiselect ? ' colspan="2"': "",
                a.each(l.groups,
                function(f, v) {
                    if (l._locgr && !(v.startRow + v.cnt > (d - 1) * e && v.startRow < d * e)) return ! 0;
                    t++,
                    i = k.p.id + "ghead_" + v.idx,
                    h = i + "_" + f,
                    n = "<span style='cursor:pointer;margin-right:8px;margin-left:5px;' class='" + r.icon_base + " " + o + "' onclick=\"jQuery('#" + a.jgrid.jqID(k.p.id) + "').jqGrid('groupingToggle','" + h + "');return false;\"></span>";
                    try {
                    ...
                    if (y) {
                        ...
                        if ("header" !== l.groupSummaryPos[v.idx]) {
                            ...
                            for (A = 0; t > A; A++) if (u[A]) {
                                var G = "";
                                l.groupCollapse && !l.showSummaryOnHide && (G = ' style="display:none;"'),
                                m += "<tr" + G + ' jqfootlevel="' + (v.idx - A) + '" role="row" class="' + r.content + " jqfoot ui-row-" + k.p.direction + '">',
                                m += g(f, A, l.groups, 0),
                                m += "</tr>"
                            }
                            t = F
                ...
                a("#" + a.jgrid.jqID(k.p.id) + " tbody:first").append(m),
                m = null
            })
        },
        groupingGroupBy: function(b, c) {
            return this.each(function() {
                ...
                d.p.groupingView = a.extend(d.p.groupingView, c || {}),
                e.groupField = b,
        ...
        groupingRemove: function(b) {
            return this.each(function() {
                ...
                if (void 0 === b && (b = !0), c.p.grouping = !1, b === !0) {
                    ...
                    a("tr.jqgroup, tr.jqfoot", "#" + a.jgrid.jqID(c.p.id) + " tbody:first").remove(),
                    a("tr.jqgrow:hidden", "#" + a.jgrid.jqID(c.p.id) + " tbody:first").show()
        ...
        setGroupHeaders: function(b) {
            ...
            this.each(function() {
                ...
                q.p.groupHeader || (q.p.groupHeader = []),
                q.p.groupHeader.push(b),
                void 0 === y[0] ? y = a("<tr>", {
                    role: "row",
                    "aria-hidden": "true"
                ...
                for (a(q).prepend(x), e = a("<tr>", {
                    role: "row"
                }).addClass("ui-jqgrid-labels jqg-third-row-header"), c = 0; t > c; c++) if (g = u[c].el, h = a(g), d = s[c], i = {
                    height: "0px",
                    width: u[c].width + "px",
                ...
                a("<th>", {
                    ...
                    f = a("<th>").attr({
                        role: "columnheader"
                    }).addClass(z.headerBox + " ui-th-column-header ui-th-" + q.p.direction + " " + o).html(m),
                    n > 0 && f.attr("colspan", String(n)),
                    q.p.headertitles && f.attr("title", f.text()),
                    0 === n && f.hide(),
                    h.before(f),
                    e.append(g),
                    r = l - 1
                ...
                A = p.find("tr.jqg-first-row-header"),
                a(q).bind("jqGridResizeStop.setGroupHeaders",
                function(a, b, c) {
    ...
    a.jgrid.extend({
        setTreeNode: function(b, c) {
            return this.each(function() {
                ...
                s = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common; c > b;) {
                    var t, u = a.jgrid.stripPref(d.p.idPrefix, d.rows[b].id),
                    v = d.p._index[u];
                    k = d.p.data[v],
                    "nested" === d.p.treeGridModel && (k[o] || (e = parseInt(k[d.p.treeReader.left_field], 10), f = parseInt(k[d.p.treeReader.right_field], 10), k[o] = f === e + 1 ? "true": "false", d.rows[b].cells[d.p._treeleafpos].innerHTML = k[o])),
                    g = parseInt(k[p], 10),
                    0 === d.p.tree_root_level ? (h = g + 1, i = g) : (h = g, i = g - 1),
                    j = "<div class='tree-wrap tree-wrap-" + d.p.direction + "' style='width:" + 18 * h + "px;'>",
                    j += "<div style='" + ("rtl" === d.p.direction ? "right:": "left:") + 18 * i + "px;' class='" + s.icon_base + " ",
                    void 0 !== k[r] && (k[r] = "true" === k[r] || k[r] === !0 ? !0 : !1),
                    "true" === k[o] || k[o] === !0 ? (j += (void 0 !== k[q] && "" !== k[q] ? k[q] : d.p.treeIcons.leaf) + " tree-leaf treeclick", k[o] = !0, l = "leaf") : (k[o] = !1, l = ""),
                    k[n] = ("true" === k[n] || k[n] === !0 ? !0 : !1) && (k[r] || void 0 === k[r]),
                    j += k[n] === !1 ? k[o] === !0 ? "'": d.p.treeIcons.plus + " tree-plus treeclick'": k[o] === !0 ? "'": d.p.treeIcons.minus + " tree-minus treeclick'",
                    j += "></div></div>",
                    a(d.rows[b].cells[m]).wrapInner("<span class='cell-wrapper" + l + "'></span>").prepend(j),
                    g !== parseInt(d.p.tree_root_level, 10) && (t = a(d).jqGrid("isVisibleNode", k), t || a(d.rows[b]).css("display", "none")),
        ...
        setTreeGrid: function() {
            return this.each(function() {
                ...
                if (f.p.treeGrid) {
                    ...
                    f.p.loadonce && (f.p.treedatatype = "local"),
                    f.p.subGrid = !1,
                    f.p.altRows = !1,
                    f.p.pgbuttons = !1,
                    f.p.pginput = !1,
                    ...
                    f.p.expColInd = 0,
                    b = j.icon_plus,
                    "jQueryUI" === f.p.styleUI && (b += "rtl" === f.p.direction ? "w": "e"),
        ...
        collapseRow: function(b) {
            this.each(function() {
                ...
                if (c.grid && c.p.treeGrid) {
                    ...
                    g !== !1 && (a(d).each(function() {
                        var b = c.p.idPrefix + a.jgrid.getAccessor(this, c.p.localReader.id);
                        a(a(c).jqGrid("getGridRowById", b)).css("display", "none"),
        ...
        getRootNodes: function(b) {
            ...
            return this.each(function() {
                ...
                case "nested":
                    d = g.p.treeReader.level_field,
                    a(f).each(function() {
                        parseInt(this[d], 10) === parseInt(g.p.tree_root_level, 10) && c.push(b ? g.p.data[g.p._index[this[g.p.keyName]]] : this)
                    });
                    break;
                case "adjacency":
                    e = g.p.treeReader.parent_id_field,
                    a(f).each(function() { (null === this[e] || "null" === String(this[e]).toLowerCase()) && c.push(b ? g.p.data[g.p._index[this[g.p.keyName]]] : this)
                    })
                }
            }),
            c
        ...
        getNodeParent: function(b) {
            ...
            return this.each(function() {
                ...
                case "nested":
                    ...
                    break;
                case "adjacency":
                    for (var k = d.p.treeReader.parent_id_field,
                    l = d.p.localReader.id,
                    m = b[l], n = d.p._index[m]; n--;) if (d.p.data[n][l] === a.jgrid.stripPref(d.p.idPrefix, b[k])) {
                        c = d.p.data[n];
                        break
                    }
                }
        ...
        getFullTreeNode: function(b, c) {
            ...
            return this.each(function() {
                ...
                case "nested":
                    var h = f.p.treeReader.left_field,
                ...
                case "adjacency":
                    if (b) {
                        d.push(b);
                        var n = f.p.treeReader.parent_id_field,
        ...
        reloadNode: function(b) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    k = a.jgrid.getAccessor(b, this.p.localReader.id),
                    l = a("#" + k, this.grid.bDiv)[0];
                    b[e] = !0,
            ...
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (b[c]) {
                        ...
                        if (b[c] = !1, e === !1) return;
                        a("div.treeclick", f).removeClass(this.p.treeIcons.minus + " tree-minus").addClass(this.p.treeIcons.plus + " tree-plus"),
                        a.isFunction(this.p.afterCollapseTreeGridNode) && this.p.afterCollapseTreeGridNode.call(this, d, b)
                    }
                }
            })
        },
        SortTree: function(b, c, d, e) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    for (i = a.jgrid.from.call(this, m), i.orderBy(b, c, d, e), j = i.select(), f = 0, g = j.length; g > f; f++) h = j[f],
                    k.push(h),
        ...
        searchTree: function(b) {
            var c, d, e, f = b.length || 0,
            g = [],
            h = [],
            i = [];
            return this.each(function() {
                if (this.grid && this.p.treeGrid && f) for (d = this.p.localReader.id, c = 0; f > c; c++) g = a(this).jqGrid("getNodeAncestors", b[c]),
                g.length || g.push(b[c]),
                e = g[g.length - 1][d],
                -1 === a.inArray(e, h) && (h.push(e), g = a(this).jqGrid("getFullTreeNode", g[g.length - 1], !0), i = i.concat(g))
            }),
            i
        },
        collectChildrenSortTree: function(b, c, d, e, f, g) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var h, i, j, k, l, m;
                    for (k = a(this).jqGrid("getNodeChildren", c), l = a.jgrid.from.call(this, k), l.orderBy(d, e, f, g), m = l.select(), h = 0, i = m.length; i > h; h++) j = m[h],
                    b.push(j),
    ...
    a.jgrid.extend({
        pivotSetup: function(c, d) {
            ...
            return this.each(function() {
                ...
                function o(b, c, d, e) {
                    var f, g, j, k, l = c.length,
                    m = "",
                    o = [];
                    for (a.isArray(d) ? (k = d.length, o = d) : (k = 1, o[0] = d), h = [], i = [], h.root = 0, e._count ? e._count++:e._count = 1, j = 0; k > j; j++) {
                        var p, q = [];
                        for (f = 0; l > f; f++) {
                            if (null == d) g = a.trim(c[f].member) + "_" + c[f].aggregator,
                            p = g,
                            o[0] = c[f].label || c[f].aggregator + " " + a.trim(c[f].member);
                            else {
                                p = d[j].replace(/\s+/g, "");
                                try {
                            ...
                            g = isNaN(parseInt(g, 10)) ? g: g + " ",
                            e[g] = q[g] = n(c[f].aggregator, e[g], c[f].member, b, e._count),
                            1 >= j && "_r_Totals" !== p && "" === m && (m = p)
                        }
                        h[g] = q,
                        i[g] = o[j]
                    }
                    ...
                    for (d in a) if (a.hasOwnProperty(d)) {
                        if ("object" != typeof a[d]) {
                            if ("level" === d) {
                                if (void 0 === L[a.level] && (L[a.level] = "", a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (k[a.level - 1] = {
                                    ...
                                    var h = k[a.level - 1].groupHeaders.length - 1,
                                    i = 0 === h ? N: M + v;
                                    if (a.level - 1 === (l.rowTotals ? 1 : 0) && h > 0) {
                                        for (var j = 0,
                                        m = 0; h > m; m++) j += k[a.level - 1].groupHeaders[m].numberOfColumns;
                                        j && (i = j + t)
                                    }
                                    e[i] && (k[a.level - 1].groupHeaders[h].startColumnName = e[i].name, k[a.level - 1].groupHeaders[h].numberOfColumns = e.length - i),
                                    M = e.length
                                }
                                L[a.level] = a.text
                            }
                        ...
                        if (null != a[d] && "object" == typeof a[d] && p(a[d]), "level" === d && a.level > 0 && (a.level === (0 === u ? a.level: u) || -1 !== L[a.level].indexOf("_r_Totals"))) {
                            ...
                            for (b in a.fields) if (a.fields.hasOwnProperty(b)) {
                                ...
                                v > 1 ? (g.name = b, g.label = l.aggregates[c].label || a.label) : (g.name = a.text, g.label = "_r_Totals" === a.text ? l.rowTotalsText: a.label),
                                e.push(g),
                                c++
                            }
                        }
                ...
                var q, r, s, t, u, v, w, x, y = c.length,
                z = 0;
                ...
                null == l.xDimension[s].isGroupField && (l.xDimension[s].isGroupField = !0),
                B = a.extend(!0, B, l.xDimension[s]),
                e.push(B);
                for (var C = t - 1,
                D = {}; y > z;) {
                    q = c[z];
                    ...
                    w = {},
                    s = 0;
                    do E[s] = a.trim(q[l.xDimension[s].dataName]),
                    w[l.xDimension[s].dataName] = E[s],
                    s++;
                    while (t > s);
                    var G = 0;
                    if (r = -1, x = d(f, m, E)) {
                        if (r >= 0) {
                            if (G = 0, u >= 1) {
                                for (G = 0; u > G; G++) F[G] = a.trim(q[l.yDimension[G].dataName]),
                                l.yDimension[G].converter && a.isFunction(l.yDimension[G].converter) && (F[G] = l.yDimension[G].converter.call(this, F[G], E, F));
                ...
                p(D);
                var O;
                if (l.colTotals) for (var P = f.length; P--;) for (s = t; s < e.length; s++) O = e[s].name,
                g[O] ? g[O] += parseFloat(f[P][O] || 0) : g[O] = parseFloat(f[P][O] || 0);
                if (C > 0) for (s = 0; C > s; s++) e[s].isGroupField && (j.groupingView.groupField.push(e[s].name), j.groupingView.groupSummary.push(l.groupSummary), j.groupingView.groupSummaryPos.push(l.groupSummaryPos));
                else j.grouping = !1;
                j.sortname = e[C].name,
                j.groupingView.hideFirstGroupCol = !0
            }),
            {
                colModel: e,
                rows: f,
        ...
        jqPivot: function(b, c, d, e) {
            return this.each(function() {
                function f(b) {
                    var e, f, h, i, j = jQuery(g).jqGrid("pivotSetup", b, c),
                    k = a.assocArraySize(j.summary) > 0 ? !0 : !1,
                    l = a.jgrid.from.call(g, j.rows);
                    for (c.ignoreCase && (l = l.ignoreCase()), e = 0; e < j.groupOptions.groupingView.groupField.length; e++) f = c.xDimension[e].sortorder ? c.xDimension[e].sortorder: "asc",
                    h = c.xDimension[e].sorttype ? c.xDimension[e].sorttype: "text",
                    l.orderBy(j.groupOptions.groupingView.groupField[e], f, h, "", h);
                    i = c.xDimension.length,
    ...
    a.extend(a.jgrid, {
            ...
            c || {}), b) {
                ...
                if (h.grid) {
                    if (e = a(h).data("inlineNav"), e && h.p.inlineNav && a(h).jqGrid("setGridParam", {
                        ...
                        d = window[c.compressionModule][c.compressionMethod](f),
                        null != d && (f = d, g = window[c.compressionModule][c.compressionMethod](g))
                    } catch(i) {}
                    if (c.useStorage && a.jgrid.isLocalStorage()) try {
                        window[c.storageType].setItem("jqGrid" + h.p.id, f),
                        window[c.storageType].setItem("jqGrid" + h.p.id + "_data", g)
                    } catch(i) {
        ...
        loadState: function(b, c, d) {
            ...
            d || {}), b) {
                ...
                if (d.useStorage) try {
                    c = window[d.storageType].getItem("jqGrid" + j.id),
                    g = window[d.storageType].getItem("jqGrid" + j.id + "_data")
                } catch(k) {}
                if (c) {
                    if (d.decompression && d.decompressionModule) try {
                        e = window[d.decompressionModule][d.decompressionMethod](c),
                        null != e && (c = e, g = window[d.decompressionModule][d.decompressionMethod](g))
                    } catch(k) {}
                    if (e = jqGridUtils.parse(c), e && "object" === a.type(e)) {
                        j.grid && a.jgrid.gridUnload(b),
                        ...
                        e.datatype = "local",
                        e.grouping = !1,
                        e.inlineNav && (h = l(e._iN), e._iN = null, delete e._iN),
                        e.filterToolbar && (i = l(e._fT), e._fT = null, delete e._fT);
                        var n = a("#" + b).jqGrid(e);
                        ...
                        e.inlineNav && h && (n.jqGrid("setGridParam", {
                            inlineNav: !1
                        }), n.jqGrid("inlineNav", e.pager, h)),
                        e.filterToolbar && i && (n.jqGrid("setGridParam", {
                            filterToolbar: !1
                        }), i.restoreFromFilters = !0, n.jqGrid("filterToolbar", i)),
                        e.frozenColumns && n.jqGrid("setFrozenColumns"),
                        n[0].updatepager(!0, !0),
                        a.isFunction(d.afterSetGrid) && d.afterSetGrid(n),
                        d.clearAfterLoad && (window[d.storageType].removeItem("jqGrid" + j.id), window[d.storageType].removeItem("jqGrid" + j.id + "_data"))
        ...
        isGridInStorage: function(b, c) {
            ...
            var e, f, g;
            try {
                f = window[d.storageType].getItem("jqGrid" + b),
                g = window[d.storageType].getItem("jqGrid" + b + "_data"),
                e = null != f && null != g && "string" == typeof f && "string" == typeof g
            } catch(h) {
                e = !1
            }
            return e
        ...
        setRegional: function(b, c) {
            ...
            if (d = a.extend(d, c || {}), d.regional) {
                ...
                -1 !== g && h && a("#" + b + " tbody tr").each(function() {
                    var b = this.cells[g];
                    a(b).find(".ui-inline-edit").attr("title", h.edittitle),
                    a(b).find(".ui-inline-del").attr("title", h.deltitle),
                    a(b).find(".ui-inline-save").attr("title", h.savetitle),
                    a(b).find(".ui-inline-cancel").attr("title", h.canceltitle)
                });
                try {
                    window[d.storageType].removeItem("jqGrid" + e.id),
                    window[d.storageType].removeItem("jqGrid" + e.id + "_data")
                } catch(i) {}
            }
        },
            ...
            e = function(b, c) {
                ...
                if (jqGridUtils.xmlToJSON) {
                    ...
                    if (i) {
                        ...
                        e.grid.datastr = b,
                        a(d).jqGrid(f).jqGrid("setGridParam", {
                            datatype: j
                        })
            ...
            case "xml":
                a.ajax(a.extend({
                    ...
                    complete: function(b, f) {
                        "success" === f && (e(b.responseXML, c), a(d).triggerHandler("jqGridImportComplete", [b, c]), a.isFunction(c.importComplete) && c.importComplete(b)),
                        b = null
                    }
                },
                c.ajaxOptions));
            ...
            case "json":
                a.ajax(a.extend({
                    ...
                    complete: function(b) {
                        try {
                            f(b.responseText, c),
                            a(d).triggerHandler("jqGridImportComplete", [b, c]),
                            a.isFunction(c.importComplete) && c.importComplete(b)
                        } catch(e) {}
                        b = null
                    }
                },
    ...
    a.jgrid.extend({
        jqGridExport: function(b) {
            ...
            return this.each(function() {
                if (this.grid) {
                    var d, e = a.extend(!0, {},
                    a(this).jqGrid("getGridParam"), b.addOptions);
            ...
            this.each(function() {
                if (this.grid) {
                    ...
                    if ("remote" === b.exptype) {
                        ...
                        c = -1 !== b.url.indexOf("?") ? b.url + "&" + e: b.url + "?" + e,
                        window.location = c
                    }
                }
            })
